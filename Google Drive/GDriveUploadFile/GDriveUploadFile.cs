...
{
    public class GDriveUploadFile : IActivity
    {
        public string ServiceAccountEmail;
        public string PrivateKey;

        public string Name, FilePath, UserId, ParentID;
        ...
        private string UploadFile()
        {
            ...
            {
                var mimeType = GetMimeType(FilePath.Split('.').Last());
                var parents = new List<string>();
                if (ParentID != null && ParentID != "")
                    parents.Add(ParentID);
                var request = t.Files.Create(new Google.Apis.Drive.v3.Data.File()
                {
                    Name = Name,
                    Parents = parents
                }, fileStream, mimeType);

                var prog = request.Upload();
