	...
	public class CustomActivity : IActivity
	{
		...
		public ICustomActivityResult Execute()
		{
			...
			try
			{
				...
				var httpWebRequest = (HttpWebRequest)WebRequest.Create(instanceURL + "/api/now/table/" + tableType + "?sysparm_display_value=true&sysparm_query=number=" + ticketNumber);
				...
				using(var streamReader = new StreamReader(httpResponse.GetResponseStream()))
				{
					...
					else
					{
						...
						{
							var ticketData = jsonResults["result"][i].ToString();
							var res = ExposeJson(JObject.Parse(ticketData))
