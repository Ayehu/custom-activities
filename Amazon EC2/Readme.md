This activity leverages the AWS CLI tool.  Ensure that the user running the Ayehu NG Manager service is able to run the AWS CLI tool.  Follow the steps in the <b>"Installing AWS CLI.pdf"</b> document.
<br><br>
