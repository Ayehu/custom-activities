...
{
    public class CustomActivity_AY_PolicyActionUpdateScheduleData : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return "Server/Api/policyAction/updateScheduleData";
        }
    }
