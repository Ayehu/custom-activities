...
{
    public class CustomActivity_AY_WorkflowSaveWorkflowProperties : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return "Server/Api/workflow/saveWorkflowProperties";
        }
    }
