...
{
    public class CustomActivity_AY_WorkflowSaveAsWorkflowProperties : IActivityAsync
    {
    ...
    public string workflowProperties = "";
    ...
    private string uriBuilderPath {
        get {
            return "Server/Api/workflow/saveAsWorkflowProperties";
        }
    }
