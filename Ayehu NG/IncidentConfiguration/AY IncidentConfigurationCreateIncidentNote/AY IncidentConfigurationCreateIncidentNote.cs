...
{
    public class CustomActivity_AY_IncidentConfigurationCreateIncidentNote : IActivityAsync
    {
    ...
    public string incidentsNotesEntity = "";
    ...
    private string uriBuilderPath {
        get {
            return "Server/API/IncidentConfiguration/createIncidentNote";
        }
    }
