...
Public schedule_for_reminder as string
...
If String.IsNullOrEmpty(schedule_for_reminder) = False Then queryString("schedule_for_reminder") = schedule_for_reminder
RequestURL="https://api.zoom.us/v2/meetings/" & meetingId & "?"& queryString.ToString()
