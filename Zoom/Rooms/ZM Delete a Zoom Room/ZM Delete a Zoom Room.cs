...
{
    public class ZM_Delete_a_Zoom_Room : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public ZM_Delete_a_Zoom_Room() {
    }
    
    public ZM_Delete_a_Zoom_Room(string Jsonkeypath, string apikey, string password1, string roomId) {
