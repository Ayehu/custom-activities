...
{
    public class ZM_Get_Zoom_Room_Profile : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public ZM_Get_Zoom_Room_Profile() {
    }
    
    public ZM_Get_Zoom_Room_Profile(string Jsonkeypath, string apikey, string password1, string roomId) {
