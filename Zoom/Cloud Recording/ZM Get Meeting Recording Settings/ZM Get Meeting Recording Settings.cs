...
{
    public class ZM_Get_Meeting_Recording_Settings : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public ZM_Get_Meeting_Recording_Settings() {
    }
    
    public ZM_Get_Meeting_Recording_Settings(string Jsonkeypath, string apikey, string password1, string meetingId) {
