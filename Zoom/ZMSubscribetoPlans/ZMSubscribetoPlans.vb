...
Public plan_base as string
Public plan_zoom_rooms as string
Public plan_room_connector as string
Public plan_audio as string
        ...
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""contact"": {    ""first_name"": """",    ""last_name"": """",    ""email"": """",    ""phone_number"": """",    ""address"": """",    ""apt"": """",    ""city"": """",    ""state"": """",    ""zip"": """",    ""country"": """"  },  ""plan_base"" : " & plan_base & "    ""type"": """",    ""hosts"": """"  },  ""plan_zoom_rooms"" : " & plan_zoom_rooms & "    ""type"": """",    ""hosts"": """"  },  ""plan_room_connector"" : " & plan_room_connector & "    ""type"": """",    ""hosts"": """"  },  ""plan_large_meeting"": [    {      ""type"": """",      ""hosts"": """"    }  ],  ""plan_webinar"": [    {      ""type"": """",      ""hosts"": """"    }  ],  ""plan_recording"": """",  ""plan_audio"" : " & plan_audio & "    ""type"": """",    ""tollfree_countries"": """",    ""premium_countries"": """",    ""callout_countries"": """",    ""ddi_numbers"": """"  },  ""plan_phone"": {    ""plan_base"" : " & plan_base & "      ""type"": """",      ""callout_countries"": """"    },    ""plan_calling"": [      {        ""type"": """",        ""hosts"": """"      }    ],    ""plan_number"": [      {        ""type"": """",        ""hosts"": """"      }    ]  }}"
            ...
            RequestURL="https://api.zoom.us/v2/accounts/" & accountId & "/plans?"& queryString.ToString()
