...
Public location_id as string
        ...
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""name"" : " & Microsoft.VisualBasic.Strings.Chr(34) & name1 & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""type"" : " & Microsoft.VisualBasic.Strings.Chr(34) & type & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""location_id"" : " & Microsoft.VisualBasic.Strings.Chr(34) & location_id & Microsoft.VisualBasic.Strings.Chr(34) & "}"
            ...
            RequestURL="https://api.zoom.us/v2/rooms?"& queryString.ToString()
