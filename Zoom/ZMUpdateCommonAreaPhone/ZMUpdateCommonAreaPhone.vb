...
Public ApiSecret as string
        ...
        Public commonAreaPhoneId as string
...
Public mac_address as string
        ...
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""site_id"" : " & Microsoft.VisualBasic.Strings.Chr(34) & site_id & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""display_name"" : " & Microsoft.VisualBasic.Strings.Chr(34) & display_name & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""extension_number"" : " & extension_number & ",  ""mac_address"" : " & Microsoft.VisualBasic.Strings.Chr(34) & mac_address & Microsoft.VisualBasic.Strings.Chr(34) & "}"
            ...
            RequestURL="https://api.zoom.us/v2/phone/common_area_phone/" & commonAreaPhoneId & "?"& queryString.ToString()
