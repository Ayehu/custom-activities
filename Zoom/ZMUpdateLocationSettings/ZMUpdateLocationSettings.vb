...
Public setting_type as string
        ...
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""client_alert"": {    ""detect_microphone_error_alert"": false,    ""detect_bluetooth_microphone_error_alert"": false,    ""detect_speaker_error_alert"": true,    ""detect_bluetooth_speaker_error_alert"": false,    ""detect_camera_error_alert"": true  },  ""notification"": {    ""audio_not_meet_usability_threshold"": false,    ""audio_meet_usability_threshold"": false,    ""battery_low_and_not_charging"": true,    ""battery_is_charging"": false,    ""battery_percentage"": ""in ut incididunt velit"",    ""controller_scheduling_disconnected"": false,    ""controller_scheduling_reconnected"": false,    ""cpu_usage_high_detected"": false,    ""network_unstable_detected"": true,    ""zoom_room_offline"": false,    ""zoom_room_come_back_online"": true,    ""sip_registration_failed"": false,    ""sip_registration_re_enabled"": true,    ""mic_speaker_camera_disconnected"": true,    ""mic_speaker_camera_reconnected"": false,    ""zoom_room_display_disconnected"": false  }}"
            ...
            RequestURL="https://api.zoom.us/v2/rooms/locations/" & locationId & "/settings?"& queryString.ToString()
