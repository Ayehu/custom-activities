...
{
    public class CustomActivity_ZM_Add_Members_to_a_Call_Queue : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("v2/phone/call_queues/{0}/members",callQueueId);
        }
    }
    
    private string postData {
        get {
            return string.Format("{{   \"members\": {{     \"users\": [       {{         \"id\": \"{0}\",         \"email\": \"{1}\"       }}     ]   }} }}",id_p,email);
        }
    }
