...
{
    public class ZM_Unassign_all_Members : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public ZM_Unassign_all_Members() {
    }
    
    public ZM_Unassign_all_Members(string Jsonkeypath, string apikey, string password1, string callQueueId) {
