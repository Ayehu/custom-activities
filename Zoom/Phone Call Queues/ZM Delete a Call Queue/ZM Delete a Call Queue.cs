...
{
    public class ZM_Delete_a_Call_Queue : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public ZM_Delete_a_Call_Queue() {
    }
    
    public ZM_Delete_a_Call_Queue(string Jsonkeypath, string apikey, string password1, string callQueueId) {
