...
{
    public class CustomActivity_ZM_Update_Phone_Site_Details : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("v2/phone/sites/{0}",siteId);
        }
    }
    
    private string postData {
        get {
            return string.Format("{{   \"name\": \"{0}\",   \"site_code\": \"{1}\" }}",name_p,site_code);
        }
    }
