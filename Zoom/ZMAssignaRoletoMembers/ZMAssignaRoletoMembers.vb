...
Public email as string
        ...
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""members"": [    {      ""id"" : " & Microsoft.VisualBasic.Strings.Chr(34) & id1 & Microsoft.VisualBasic.Strings.Chr(34) & "    },    {      ""id"" : " & Microsoft.VisualBasic.Strings.Chr(34) & id1 & Microsoft.VisualBasic.Strings.Chr(34) & "    }  ]}"
            ...
            RequestURL="https://api.zoom.us/v2/roles/" & roleId & "/members?"& queryString.ToString()
