...
Public ApiSecret as string
        ...
        Dim TableName As String = "questions"
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""questions"": [    {      ""field_name"": """",      ""required"": """"    }  ],  ""custom_questions"": [    {      ""title"": """",      ""type"": """",      ""required"": """",      ""answers"": [        ""array of answer choices""      ]    }  ]}"
            ...
            RequestURL="https://api.zoom.us/v2/webinars/" & webinarId & "/registrants/questions?"& queryString.ToString()
