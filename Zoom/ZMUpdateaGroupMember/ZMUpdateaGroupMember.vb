...
Public target_group_id as string
        ...
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""action"" : " & Microsoft.VisualBasic.Strings.Chr(34) & action & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""target_group_id"" : " & Microsoft.VisualBasic.Strings.Chr(34) & target_group_id & Microsoft.VisualBasic.Strings.Chr(34) & "}"
            ...
            RequestURL="https://api.zoom.us/v2/groups/" & groupId & "/members/" & memberId & "?"& queryString.ToString()
