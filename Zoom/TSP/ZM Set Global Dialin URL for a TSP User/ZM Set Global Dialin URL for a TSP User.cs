...
{
    public class CustomActivity_ZM_Set_Global_Dialin_URL_for_a_TSP_User : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("v2/users/{0}/tsp/settings",userId);
        }
    }
    
    private string postData {
        get {
            return string.Format("{{   \"audio_url\": \"{0}\" }}",audio_url);
        }
    }
