...
{
    public class ZM_Delete_a_Users_TSP_Account : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public ZM_Delete_a_Users_TSP_Account() {
    }
    
    public ZM_Delete_a_Users_TSP_Account(string Jsonkeypath, string apikey, string password1, string userId, string tspId) {
