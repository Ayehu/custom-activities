...
{
    public class ZM_Get_a_Users_TSP_Account : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public ZM_Get_a_Users_TSP_Account() {
    }
    
    public ZM_Get_a_Users_TSP_Account(string Jsonkeypath, string apikey, string password1, string userId, string tspId) {
