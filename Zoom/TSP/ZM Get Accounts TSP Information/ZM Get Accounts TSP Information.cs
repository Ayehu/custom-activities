...
{
    public class ZM_Get_Accounts_TSP_Information : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public ZM_Get_Accounts_TSP_Information() {
    }
    
    public ZM_Get_Accounts_TSP_Information(string Jsonkeypath, string apikey, string password1) {
