...
{
    public class ZM_Add_a_Users_TSP_Account : IActivityAsync
    {
...
_uriBuilderPath = string.Format("v2/users/{0}/tsp",userId);
            }
...
return _queryStringArray;
    ...
    public ZM_Add_a_Users_TSP_Account() {
    }
    
    public ZM_Add_a_Users_TSP_Account(string Jsonkeypath, string apikey, string password1, string userId, string conference_code, string leader_pin, string dial_in_numbers, string tsp_bridge) {
