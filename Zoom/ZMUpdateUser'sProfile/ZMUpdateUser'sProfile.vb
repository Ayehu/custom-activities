...
Public site_id as string
        ...
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""extension_number"" : " & Microsoft.VisualBasic.Strings.Chr(34) & extension_number & Microsoft.VisualBasic.Strings.Chr(34) & "}"
            ...
            RequestURL="https://api.zoom.us/v2/phone/users/" & userId & "?"& queryString.ToString()
