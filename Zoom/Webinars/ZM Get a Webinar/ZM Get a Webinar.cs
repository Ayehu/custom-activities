...
{
    public class ZM_Get_a_Webinar : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public ZM_Get_a_Webinar() {
    }
    
    public ZM_Get_a_Webinar(string Jsonkeypath, string apikey, string password1, string webinarId, string occurrence_id) {
