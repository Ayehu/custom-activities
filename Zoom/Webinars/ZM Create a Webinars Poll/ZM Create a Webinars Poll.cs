...
{
    public class CustomActivity_ZM_Create_a_Webinars_Poll : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("v2/webinars/{0}/polls",webinarId);
        }
    }
    
    private string postData {
        get {
            return string.Format("{{   \"title\": \"{0}\",   \"questions\": [     {{       \"name\": \"{1}\",       \"type\": \"{2}\"     }}   ] }}",title,name_p,type);
        }
    }
