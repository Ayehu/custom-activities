...
{
    public class ZM_Remove_a_Panelist : IActivityAsync
    {
...
_uriBuilderPath = string.Format("v2/webinars/{0}/panelists/{1}",webinarId,panelistId);
            }
...
return _queryStringArray;
    ...
    public ZM_Remove_a_Panelist() {
    }
    
    public ZM_Remove_a_Panelist(string Jsonkeypath, string apikey, string password1, string webinarId, string panelistId) {
