...
{
    public class ZM_Delete_a_Webinar : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public ZM_Delete_a_Webinar() {
    }
    
    public ZM_Delete_a_Webinar(string Jsonkeypath, string apikey, string password1, string webinarId, string occurrence_id) {
