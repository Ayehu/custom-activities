...
{
    public class CustomActivity_ZM_Get_a_Webinar_Registrant : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("v2/webinars/{0}/registrants/{1}",webinarId,registrantId);
        }
    }
    ...
    private System.Collections.Generic.Dictionary<string, string> queryStringArray {
        get {
            return new Dictionary<string, string>() {{"occurrence_id",occurrence_id}};
        }
    }
