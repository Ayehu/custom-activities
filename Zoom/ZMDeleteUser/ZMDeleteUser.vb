...
Public transfer_email as string
Public transfer_meeting as string
Public transfer_webinar as string
Public transfer_recording as string


        Dim Httpmethod As String = "delete"
        ...
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            If String.IsNullOrEmpty(action) = False Then queryString("action") = action
If String.IsNullOrEmpty(transfer_email) = False Then queryString("transfer_email") = transfer_email
If String.IsNullOrEmpty(transfer_meeting) = False Then queryString("transfer_meeting") = transfer_meeting
If String.IsNullOrEmpty(transfer_webinar) = False Then queryString("transfer_webinar") = transfer_webinar
If String.IsNullOrEmpty(transfer_recording) = False Then queryString("transfer_recording") = transfer_recording
