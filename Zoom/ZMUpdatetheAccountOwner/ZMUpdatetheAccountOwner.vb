...
Public email as string
        ...
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""email"" : " & Microsoft.VisualBasic.Strings.Chr(34) & email & Microsoft.VisualBasic.Strings.Chr(34) & "}"
            ...
            RequestURL="https://api.zoom.us/v2/accounts/" & accountId & "/owner?"& queryString.ToString()
