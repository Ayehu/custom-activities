...
Public ApiSecret as string
        ...
        Public webinarId as string
Public application/json as string
Public occurrence_id as string
        ...
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""topic"": """",  ""type"": """",  ""start_time"": """",  ""duration"": """",  ""timezone"": """",  ""password"": """",  ""agenda"": """",  ""settings"": {    ""host_video"": """",    ""panelists_video"": """",    ""practice_session"": """",    ""hd_video"": """",    ""approval_type"": """",    ""registration_type"": """",    ""audio"": """",    ""auto_recording"": """",    ""enforce_login"": """",    ""enforce_login_domains"": """",    ""alternative_hosts"": """",    ""close_registration"": """",    ""show_share_button"": """",    ""allow_multiple_devices"": """",    ""registrants_confirmation_email"": """",    ""notify_registrants"": """",    ""registrants_email_notification"": """"  }}"
            ...
            RequestURL="https://api.zoom.us/v2/webinars/" & webinarId & "?"& queryString.ToString()
