...
Public hosts as string
        ...
        Dim TableName As String = "addons"
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""type"" : " & Microsoft.VisualBasic.Strings.Chr(34) & type & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""hosts"" : " & Microsoft.VisualBasic.Strings.Chr(34) & hosts & Microsoft.VisualBasic.Strings.Chr(34) & "}"
            ...
            RequestURL="https://api.zoom.us/v2/accounts/" & accountId & "/plans/addons?"& queryString.ToString()
