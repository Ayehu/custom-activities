...
Public password as string
        ...
        Dim TableName As String = "password"
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""password"" : " & Microsoft.VisualBasic.Strings.Chr(34) & password & Microsoft.VisualBasic.Strings.Chr(34) & "}"
            ...
            RequestURL="https://api.zoom.us/v2/users/" & userId & "/password?"& queryString.ToString()
