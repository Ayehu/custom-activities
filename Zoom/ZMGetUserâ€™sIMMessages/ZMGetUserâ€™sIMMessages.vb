...
Public next_page_token as string
        ...
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            If String.IsNullOrEmpty(chat_user) = False Then queryString("chat_user") = chat_user
If String.IsNullOrEmpty(channel) = False Then queryString("channel") = channel
...
RequestURL="https://api.zoom.us/v2/im/users/" & userId & "/chat/messages?"& queryString.ToString()
