...
Public account_id as string
        ...
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""account_id"" : " & Microsoft.VisualBasic.Strings.Chr(34) & account_id & Microsoft.VisualBasic.Strings.Chr(34) & "}"
            ...
            RequestURL="https://api.zoom.us/v2/accounts/" & accountId & "/users/" & userId & "/account?"& queryString.ToString()
