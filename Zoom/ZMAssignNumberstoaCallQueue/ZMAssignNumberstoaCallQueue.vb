...
Public number as string
        ...
        Dim TableName As String = "phone_numbers"
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""phone_numbers"": [    {      ""id"" : " & Microsoft.VisualBasic.Strings.Chr(34) & id1 & Microsoft.VisualBasic.Strings.Chr(34) & ",      ""number"" : " & Microsoft.VisualBasic.Strings.Chr(34) & number & Microsoft.VisualBasic.Strings.Chr(34) & "    }  ]}"
            ...
            RequestURL="https://api.zoom.us/v2/phone/call_queues/" & callQueueId & "/phone_numbers?"& queryString.ToString()
