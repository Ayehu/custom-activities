...
{
    public class ZM_Get_Plan_Information : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public ZM_Get_Plan_Information() {
    }
    
    public ZM_Get_Plan_Information(string Jsonkeypath, string apikey, string password1, string accountId) {
