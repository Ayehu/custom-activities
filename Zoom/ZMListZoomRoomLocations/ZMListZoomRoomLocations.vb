...
Public ApiSecret as string
        ...
        Public parent_location_id as string
...
Public next_page_token as string
        ...
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            If String.IsNullOrEmpty(parent_location_id) = False Then queryString("parent_location_id") = parent_location_id
...
RequestURL="https://api.zoom.us/v2/rooms/locations?"& queryString.ToString()
