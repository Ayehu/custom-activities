...
Public type as string
        ...
        Dim TableName As String = "calling_plans"
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""calling_plans"": [    {      ""type"" : " & Microsoft.VisualBasic.Strings.Chr(34) & type & Microsoft.VisualBasic.Strings.Chr(34) & "    },    {      ""type"" : " & Microsoft.VisualBasic.Strings.Chr(34) & type & Microsoft.VisualBasic.Strings.Chr(34) & "    }  ]}"
            ...
            RequestURL="https://api.zoom.us/v2/phone/users/" & userId & "/calling_plans?"& queryString.ToString()
