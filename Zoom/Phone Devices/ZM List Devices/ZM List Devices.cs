...
{
    public class CustomActivity_ZM_List_Devices : IActivityAsync
    {
    ...
    private System.Collections.Generic.Dictionary<string, string> queryStringArray {
        get {
            return new Dictionary<string, string>() {{"type",type},{"next_page_token",next_page_token},{"page_size",page_size}};
        }
    }
