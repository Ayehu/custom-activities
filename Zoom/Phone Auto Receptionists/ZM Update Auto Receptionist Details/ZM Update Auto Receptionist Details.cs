...
{
    public class CustomActivity_ZM_Update_Auto_Receptionist_Details : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("v2/phone/auto_receptionists/{0}",autoReceptionistId);
        }
    }
    
    private string postData {
        get {
            return string.Format("{{   \"name\": \"{0}\",   \"extension_number\": \"{1}\" }}",name_p,extension_number);
        }
    }
