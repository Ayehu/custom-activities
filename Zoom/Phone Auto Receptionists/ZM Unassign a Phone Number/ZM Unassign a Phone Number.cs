...
{
    public class CustomActivity_ZM_Unassign_a_Phone_Number : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("v2/phone/auto_receptionists/{0}/phone_numbers/{1}",autoReceptionistId,phoneNumberId);
        }
    }
