...
Public ApiSecret as string
        ...
        Dim TableName As String = "vanity_name"
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            If String.IsNullOrEmpty(vanity_name) = False Then queryString("vanity_name") = vanity_name
RequestURL="https://api.zoom.us/v2/users/vanity_name?"& queryString.ToString()
