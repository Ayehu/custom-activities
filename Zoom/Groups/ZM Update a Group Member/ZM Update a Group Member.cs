...
{
    public class CustomActivity_ZM_Update_a_Group_Member : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("v2/groups/{0}/members/{1}",groupId,memberId);
        }
    }
    
    private string postData {
        get {
            return string.Format("{{   \"action\": \"{0}\",   \"target_group_id\": \"{1}\" }}",action,target_group_id);
        }
    }
