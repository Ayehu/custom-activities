...
{
    public class CustomActivity_ZM_Update_a_Groups_Settings : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("v2/groups/{0}/settings",groupId);
        }
    }
    ...
    private System.Collections.Generic.Dictionary<string, string> queryStringArray {
        get {
            return new Dictionary<string, string>() {{"option",option}};
        }
    }
