...
Public ApiSecret as string
        ...
        Public blockedListId as string
Public match_type as string
Public phone_number as string
Public block_type as string
...
Public comment as string
        ...
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""match_type"" : " & Microsoft.VisualBasic.Strings.Chr(34) & match_type & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""phone_number"" : " & Microsoft.VisualBasic.Strings.Chr(34) & phone_number & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""block_type"" : " & Microsoft.VisualBasic.Strings.Chr(34) & block_type & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""status"" : " & Microsoft.VisualBasic.Strings.Chr(34) & status & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""comment"" : " & Microsoft.VisualBasic.Strings.Chr(34) & comment & Microsoft.VisualBasic.Strings.Chr(34) & "}"
            ...
            RequestURL="https://api.zoom.us/v2/phone/blocked_list/" & blockedListId & "?"& queryString.ToString()
