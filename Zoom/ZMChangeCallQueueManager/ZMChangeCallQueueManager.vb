...
Public member_id as string
        ...
        Dim TableName As String = "manager"
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""member_id"" : " & Microsoft.VisualBasic.Strings.Chr(34) & member_id & Microsoft.VisualBasic.Strings.Chr(34) & "}"
            ...
            RequestURL="https://api.zoom.us/v2/phone/call_queues/" & callQueueId & "/manager?"& queryString.ToString()
