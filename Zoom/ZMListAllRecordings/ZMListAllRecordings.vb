...
Public to1 as string
Public trash_type as string
        ...
        Dim TableName As String = "recordings"
...
If String.IsNullOrEmpty(mc) = False Then queryString("mc") = mc
If String.IsNullOrEmpty(trash) = False Then queryString("trash") = trash
If String.IsNullOrEmpty(from) = False Then queryString("from") = from
If String.IsNullOrEmpty(to1) = False Then queryString("to") = to1
If String.IsNullOrEmpty(trash_type) = False Then queryString("trash_type") = trash_type
RequestURL="https://api.zoom.us/v2/users/" & userId & "/recordings?"& queryString.ToString()
