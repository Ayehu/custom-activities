...
{
    public class ZM_Get_Locked_Settings : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public ZM_Get_Locked_Settings() {
    }
    
    public ZM_Get_Locked_Settings(string Jsonkeypath, string apikey, string password1, string accountId) {
