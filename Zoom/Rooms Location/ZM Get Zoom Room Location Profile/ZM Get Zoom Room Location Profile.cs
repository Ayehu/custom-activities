...
{
    public class ZM_Get_Zoom_Room_Location_Profile : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public ZM_Get_Zoom_Room_Location_Profile() {
    }
    
    public ZM_Get_Zoom_Room_Location_Profile(string Jsonkeypath, string apikey, string password1, string locationId) {
