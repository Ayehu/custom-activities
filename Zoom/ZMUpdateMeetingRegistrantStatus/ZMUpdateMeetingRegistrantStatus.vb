...
Public email as string
        ...
        Dim TableName As String = "status"
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""action"" : " & Microsoft.VisualBasic.Strings.Chr(34) & action & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""registrants"": [    {      ""id"" : " & Microsoft.VisualBasic.Strings.Chr(34) & id1 & Microsoft.VisualBasic.Strings.Chr(34) & ",      ""email"" : " & Microsoft.VisualBasic.Strings.Chr(34) & email & Microsoft.VisualBasic.Strings.Chr(34) & "    },    {      ""id"" : " & Microsoft.VisualBasic.Strings.Chr(34) & id1 & Microsoft.VisualBasic.Strings.Chr(34) & ",      ""email"" : " & Microsoft.VisualBasic.Strings.Chr(34) & email & Microsoft.VisualBasic.Strings.Chr(34) & "    }  ]}"
            ...
            RequestURL="https://api.zoom.us/v2/meetings/" & meetingId & "/registrants/status?"& queryString.ToString()
