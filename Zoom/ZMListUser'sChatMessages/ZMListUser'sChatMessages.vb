...
Public to_contact as string
Public to_channel as string
...
Public next_page_token as string
        ...
        Dim TableName As String = "messages"
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            If String.IsNullOrEmpty(to_contact) = False Then queryString("to_contact") = to_contact
If String.IsNullOrEmpty(to_channel) = False Then queryString("to_channel") = to_channel
If String.IsNullOrEmpty(date ) = False Then queryString("date ") = date 
...
RequestURL="https://api.zoom.us/v2/chat/users/" & userId & "/messages?"& queryString.ToString()
