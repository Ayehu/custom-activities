...
Public ApiSecret as string
        ...
        Public search_key as string
Public query_presence_status as string
...
Public next_page_token as string
        ...
        Dim TableName As String = "contacts"
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            If String.IsNullOrEmpty(search_key) = False Then queryString("search_key") = search_key
If String.IsNullOrEmpty(query_presence_status) = False Then queryString("query_presence_status") = query_presence_status
...
RequestURL="https://api.zoom.us/v2/contacts?"& queryString.ToString()
