...
Public to_jid as string
Public account_id as string
Public visible_to_user as string
Public user_jid as string
Public is_markdown_support as string
        ...
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""robot_jid"" : " & Microsoft.VisualBasic.Strings.Chr(34) & robot_jid & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""to_jid"" : " & Microsoft.VisualBasic.Strings.Chr(34) & to_jid & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""account_id"" : " & Microsoft.VisualBasic.Strings.Chr(34) & account_id & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""content"": {    ""head"": {      ""text"": ""Hello World""    },    ""body"": [      {        ""type"": ""message"",        ""text"": ""Greetings from the cool bot""      }    ]  }}"
            ...
            RequestURL="https://api.zoom.us/v2/im/chat/messages?"& queryString.ToString()
