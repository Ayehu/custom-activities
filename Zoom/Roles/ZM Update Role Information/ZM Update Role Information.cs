...
{
    public class CustomActivity_ZM_Update_Role_Information : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("v2/roles/{0}",roleId);
        }
    }
    
    private string postData {
        get {
            return string.Format("{{   \"id\": \"{0}\",   \"name\": \"{1}\",   \"description\": \"{2}\",   \"total_members\": \"{3}\" }}",id_p,name_p,description,total_members);
        }
    }
