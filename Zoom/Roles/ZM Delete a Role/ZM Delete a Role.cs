...
{
    public class ZM_Delete_a_Role : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public ZM_Delete_a_Role() {
    }
    
    public ZM_Delete_a_Role(string Jsonkeypath, string apikey, string password1, string roleId) {
