...
Public setting_type as string
        ...
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""client_alert"": {    ""detect_microphone_error_alert"": true,    ""detect_bluetooth_microphone_error_alert"": false,    ""detect_speaker_error_alert"": false,    ""detect_bluetooth_speaker_error_alert"": false,    ""detect_camera_error_alert"": true  },  ""notification"": {    ""audio_not_meet_usability_threshold"": true,    ""audio_meet_usability_threshold"": true,    ""battery_low_and_not_charging"": true,    ""battery_is_charging"": true,    ""battery_percentage"": ""do sit"",    ""controller_scheduling_disconnected"": true,    ""controller_scheduling_reconnected"": false,    ""cpu_usage_high_detected"": true,    ""network_unstable_detected"": true,    ""zoom_room_offline"": false,    ""zoom_room_come_back_online"": false,    ""sip_registration_failed"": true,    ""sip_registration_re_enabled"": false,    ""mic_speaker_camera_disconnected"": false,    ""mic_speaker_camera_reconnected"": true,    ""zoom_room_display_disconnected"": true  }}"
            ...
            RequestURL="https://api.zoom.us/v2/rooms/" & roomId & "/settings?"& queryString.ToString()
