...
Public month as string
        ...
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            If String.IsNullOrEmpty(year) = False Then queryString("year") = year
If String.IsNullOrEmpty(month) = False Then queryString("month") = month
RequestURL="https://api.zoom.us/v2/report/daily?"& queryString.ToString()
