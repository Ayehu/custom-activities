...
Public ApiSecret as string
        ...
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""title"": ""Meeting Usefulness"",  ""questions"": [    {      ""name"": ""How useful was this meeting?"",      ""type"": ""multiple"",      ""answers"": [        ""Extremely useful"",        ""Somewhat useful"",        ""Not useful at all""      ]    }  ]}"
            ...
            RequestURL="https://api.zoom.us/v2/meetings/" & meetingId & "/polls?"& queryString.ToString()
