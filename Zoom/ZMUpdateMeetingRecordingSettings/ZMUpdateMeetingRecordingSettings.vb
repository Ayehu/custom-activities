...
Public ApiSecret as string
        ...
        Public meetingId as string
Public share_recording as string
Public recording_authentication as string
Public authentication_option as string
Public authentication_domains as string
Public viewer_download as string
Public password as string
Public on_demand as string
Public approval_type as string
Public send_email_to_host as string
Public show_social_share_buttons as string
        ...
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""share_recording"" : " & Microsoft.VisualBasic.Strings.Chr(34) & share_recording & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""recording_authentication"" : " & recording_authentication & ",  ""authentication_option"" : " & Microsoft.VisualBasic.Strings.Chr(34) & authentication_option & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""authentication_domains"" : " & Microsoft.VisualBasic.Strings.Chr(34) & authentication_domains & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""viewer_download"" : " & viewer_download & ",  ""password"" : " & Microsoft.VisualBasic.Strings.Chr(34) & password & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""on_demand"" : " & on_demand & ",  ""approval_type"" : " & approval_type & ",  ""send_email_to_host"" : " & send_email_to_host & ",  ""show_social_share_buttons"" : " & show_social_share_buttons & "}"
            ...
            RequestURL="https://api.zoom.us/v2/meetings/" & meetingId & "/recordings/settings?"& queryString.ToString()
