...
Public location_id as string
        ...
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""location_id"" : " & Microsoft.VisualBasic.Strings.Chr(34) & location_id & Microsoft.VisualBasic.Strings.Chr(34) & "}"
            ...
            RequestURL="https://api.zoom.us/v2/rooms/" & roomId & "/location?"& queryString.ToString()
