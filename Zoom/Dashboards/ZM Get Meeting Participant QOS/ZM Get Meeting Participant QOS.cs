...
{
    public class CustomActivity_ZM_Get_Meeting_Participant_QOS : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("v2/metrics/meetings/{0}/participants/{1}/qos",meetingId,participantId);
        }
    }
