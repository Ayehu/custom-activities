...
{
    public class CustomActivity_ZM_Get_Webinar_Participant_QOS : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("v2/metrics/webinars/{0}/participants/{1}/qos",webinarId,participantId);
        }
    }
