...
Public ApiSecret as string
        ...
        Dim TableName As String = "structure"
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""structures"": [    ""country"",    ""city""  ]}"
            ...
            RequestURL="https://api.zoom.us/v2/rooms/locations/structure?"& queryString.ToString()
