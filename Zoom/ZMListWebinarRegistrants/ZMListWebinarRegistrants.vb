...
Public page_number as string
        ...
        Dim TableName As String = "registrants"
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            If String.IsNullOrEmpty(occurrence_id) = False Then queryString("occurrence_id") = occurrence_id
If String.IsNullOrEmpty(status) = False Then queryString("status") = status
If String.IsNullOrEmpty(page_size) = False Then queryString("page_size") = page_size
If String.IsNullOrEmpty(page_number) = False Then queryString("page_number") = page_number
RequestURL="https://api.zoom.us/v2/webinars/" & webinarId & "/registrants?"& queryString.ToString()
