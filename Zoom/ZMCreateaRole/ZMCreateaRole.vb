...
Public items as string
        ...
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""name"" : " & Microsoft.VisualBasic.Strings.Chr(34) & name1 & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""description"" : " & Microsoft.VisualBasic.Strings.Chr(34) & description & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""privileges"": [    ""User:Read"",    ""User:Edit"",    ""Group:Read"",    ""Group:Edit""  ]}"
            ...
            RequestURL="https://api.zoom.us/v2/roles?"& queryString.ToString()
