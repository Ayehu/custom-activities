...
{
    public class CustomActivity_ZM_List_Users : IActivityAsync
    {
    ...
    private System.Collections.Generic.Dictionary<string, string> queryStringArray {
        get {
            return new Dictionary<string, string>() {{"status",status},{"page_size",page_size},{"page_number",page_number},{"role_id",role_id}};
        }
    }
