...
{
    public class CustomActivity_ZM_Get_User_Settings : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("v2/users/{0}/settings",userId);
        }
    }
    ...
    private System.Collections.Generic.Dictionary<string, string> queryStringArray {
        get {
            return new Dictionary<string, string>() {{"login_type",login_type},{"option",option}};
        }
    }
