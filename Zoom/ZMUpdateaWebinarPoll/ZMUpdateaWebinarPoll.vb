...
Public pollId as string
        ...
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""title"": ""Learn something new"",  ""questions"": [    {      ""name"": ""How are you?"",      ""type"": ""multiple"",      ""answers"": [        ""Good"",        ""Not so good""      ]    }  ]}"
            ...
            RequestURL="https://api.zoom.us/v2/webinars/" & webinarId & "/polls/" & pollId & "?"& queryString.ToString()
