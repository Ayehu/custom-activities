...
{
    public class CustomActivity_ZM_List_SIP_Phones : IActivityAsync
    {
    ...
    private System.Collections.Generic.Dictionary<string, string> queryStringArray {
        get {
            return new Dictionary<string, string>() {{"page_number",page_number},{"search_key",search_key},{"page_size",page_size}};
        }
    }
