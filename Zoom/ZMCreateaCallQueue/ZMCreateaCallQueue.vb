...
Public items as string
        ...
        Dim TableName As String = "call_queues"
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""name"" : " & Microsoft.VisualBasic.Strings.Chr(34) & name1 & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""site_id"" : " & Microsoft.VisualBasic.Strings.Chr(34) & site_id & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""extension_number"" : " & extension_number & ",  ""description"" : " & Microsoft.VisualBasic.Strings.Chr(34) & description & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""members"": {    ""users"": [      {        ""email"" : " & Microsoft.VisualBasic.Strings.Chr(34) & email & Microsoft.VisualBasic.Strings.Chr(34) & "      }    ]  }}"
            ...
            RequestURL="https://api.zoom.us/v2/phone/call_queues?"& queryString.ToString()
