...
Public to_channel as string
        ...
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""message"" : " & Microsoft.VisualBasic.Strings.Chr(34) & message & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""to_contact"" : " & Microsoft.VisualBasic.Strings.Chr(34) & to_contact & Microsoft.VisualBasic.Strings.Chr(34) & "}"
            ...
            RequestURL="https://api.zoom.us/v2/chat/users/me/messages?"& queryString.ToString()
