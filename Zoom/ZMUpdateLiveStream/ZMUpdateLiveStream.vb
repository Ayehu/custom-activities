...
Public page_url as string
        ...
        Dim TableName As String = "livestream"
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""stream_url"" : " & Microsoft.VisualBasic.Strings.Chr(34) & stream_url & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""stream_key"" : " & Microsoft.VisualBasic.Strings.Chr(34) & stream_key & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""page_url"" : " & Microsoft.VisualBasic.Strings.Chr(34) & page_url & Microsoft.VisualBasic.Strings.Chr(34) & "}"
            ...
            RequestURL="https://api.zoom.us/v2/meetings/" & meetingId & "/livestream?"& queryString.ToString()
