...
Public ApiSecret as string
        ...
        Public next_page_token as string
Public type as string
Public extension_type as string
Public page_size as string
Public number_type as string
Public pending_numbers as string
        ...
        Dim TableName As String = "numbers"
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            If String.IsNullOrEmpty(next_page_token) = False Then queryString("next_page_token") = next_page_token
If String.IsNullOrEmpty(type) = False Then queryString("type") = type
If String.IsNullOrEmpty(extension_type) = False Then queryString("extension_type") = extension_type
If String.IsNullOrEmpty(page_size) = False Then queryString("page_size") = page_size
If String.IsNullOrEmpty(number_type) = False Then queryString("number_type") = number_type
If String.IsNullOrEmpty(pending_numbers) = False Then queryString("pending_numbers") = pending_numbers
RequestURL="https://api.zoom.us/v2/phone/numbers?"& queryString.ToString()
