...
{
    public class CustomActivity_ZM_Assign_SIP_Trunk_Configuration : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return "v2/accounts/{accountId}/sip_trunk/settings";
        }
    }
    
    private string postData {
        get {
            return string.Format("{{   \"enable\": \"{0}\" }}",enable);
        }
    }
