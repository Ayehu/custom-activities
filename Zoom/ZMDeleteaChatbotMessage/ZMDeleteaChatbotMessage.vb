...
Public robot_jid as string
Public user_jid as string
Public account_id as string
        ...
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""robot_jid"" : " & Microsoft.VisualBasic.Strings.Chr(34) & robot_jid & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""user_jid"" : " & Microsoft.VisualBasic.Strings.Chr(34) & user_jid & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""account_id"" : " & Microsoft.VisualBasic.Strings.Chr(34) & account_id & Microsoft.VisualBasic.Strings.Chr(34) & "}"
            ...
            If String.IsNullOrEmpty(robot_jid) = False Then queryString("robot_jid") = robot_jid
If String.IsNullOrEmpty(user_jid) = False Then queryString("user_jid") = user_jid
If String.IsNullOrEmpty(account_id) = False Then queryString("account_id") = account_id
RequestURL="https://api.zoom.us/v2/im/chat/messages/" & message_id & "?"& queryString.ToString()
