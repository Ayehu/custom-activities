...
Public audio_url as string
        ...
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""audio_url"" : " & Microsoft.VisualBasic.Strings.Chr(34) & audio_url & Microsoft.VisualBasic.Strings.Chr(34) & "}"
            ...
            RequestURL="https://api.zoom.us/v2/users/" & userId & "/tsp/settings?"& queryString.ToString()
