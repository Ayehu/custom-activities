...
Public pollId as string
        ...
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""title"": ""Meeting Usefulness"",  ""questions"": [    {      ""name"": ""Would you like to use our service again?"",      ""type"": ""multiple"",      ""answers"": [        ""Definitely"",        ""Probably"",        ""Not going to use it again""      ]    }  ]}"
            ...
            RequestURL="https://api.zoom.us/v2/meetings/" & meetingId & "/polls/" & pollId & "?"& queryString.ToString()
