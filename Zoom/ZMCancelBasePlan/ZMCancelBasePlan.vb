...
Public comment as string
        ...
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""action"" : " & Microsoft.VisualBasic.Strings.Chr(34) & action & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""reason"" : " & reason & ",  ""comment"" : " & Microsoft.VisualBasic.Strings.Chr(34) & comment & Microsoft.VisualBasic.Strings.Chr(34) & "}"
            ...
            RequestURL="https://api.zoom.us/v2/accounts/" & accountId & "/plans/base/status?"& queryString.ToString()
