...
Public active_speaker_name as string
Public display_name as string
        ...
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""action"" : " & Microsoft.VisualBasic.Strings.Chr(34) & action & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""settings"": {    ""active_speaker_name"" : " & active_speaker_name & ",    ""display_name"" : " & Microsoft.VisualBasic.Strings.Chr(34) & display_name & Microsoft.VisualBasic.Strings.Chr(34) & "  }}"
            ...
            RequestURL="https://api.zoom.us/v2/meetings/" & meetingId & "/livestream/status?"& queryString.ToString()
