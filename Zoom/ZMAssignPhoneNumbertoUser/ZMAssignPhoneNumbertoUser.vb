...
Public number as string
        ...
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""phone_numbers"": [    {      ""id"" : " & Microsoft.VisualBasic.Strings.Chr(34) & id1 & Microsoft.VisualBasic.Strings.Chr(34) & "    }  ]}"
            ...
            RequestURL="https://api.zoom.us/v2/phone/users/" & userId & "/phone_numbers?"& queryString.ToString()
