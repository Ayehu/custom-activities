...
Public items as string
        ...
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""phone_numbers"": [    ""34555665654"",    ""10004350500"",    ""000000000""  ]}"
            ...
            RequestURL="https://api.zoom.us/v2/accounts/" & accountId & "/sip_trunk/numbers?"& queryString.ToString()
