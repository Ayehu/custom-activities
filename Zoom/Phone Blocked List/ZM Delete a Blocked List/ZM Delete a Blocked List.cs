...
{
    public class ZM_Delete_a_Blocked_List : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public ZM_Delete_a_Blocked_List() {
    }
    
    public ZM_Delete_a_Blocked_List(string Jsonkeypath, string apikey, string password1, string blockedListId) {
