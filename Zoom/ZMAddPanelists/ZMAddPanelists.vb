...
Public ApiSecret as string
        ...
        Dim TableName As String = "panelists"
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""panelists"": [    {      ""name"": ""Mary"",      ""email"": ""maryjkdfdsgfshdgf@jdfdkjdglfk.jkfgdj""    },    {      ""name"": ""Mike"",      ""email"": ""dfdsgfsdhf@jkgfdgfkdhgfdjg.fkjgdf""    }  ]}"
            ...
            RequestURL="https://api.zoom.us/v2/webinars/" & webinarId & "/panelists?"& queryString.ToString()
