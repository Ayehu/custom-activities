...
Public transfer_site_id as string
        ...
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            If String.IsNullOrEmpty(transfer_site_id) = False Then queryString("transfer_site_id") = transfer_site_id
RequestURL="https://api.zoom.us/v2/phone/sites/" & siteId & "?"& queryString.ToString()
