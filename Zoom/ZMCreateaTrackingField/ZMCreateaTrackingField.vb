...
Public items as string
        ...
        Dim TableName As String = "tracking_fields"
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""field"" : " & Microsoft.VisualBasic.Strings.Chr(34) & field & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""required"" : " & required & ",  ""visible"" : " & visible & ",  ""recommended_values"": [    ""Support"",    ""Onboarding"",    ""Sales"",    ""Other""  ]}"
            ...
            RequestURL="https://api.zoom.us/v2/tracking_fields?"& queryString.ToString()
