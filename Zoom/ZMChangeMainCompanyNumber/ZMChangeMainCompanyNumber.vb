...
Public ApiSecret as string
        ...
        Dim TableName As String = "company_number"
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""phone_number"" : " & Microsoft.VisualBasic.Strings.Chr(34) & phone_number & Microsoft.VisualBasic.Strings.Chr(34) & "}"
            ...
            RequestURL="https://api.zoom.us/v2/phone/company_number?"& queryString.ToString()
