...
Public parent_location_id as string
        ...
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""name"" : " & Microsoft.VisualBasic.Strings.Chr(34) & name1 & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""parent_location_id"" : " & Microsoft.VisualBasic.Strings.Chr(34) & parent_location_id & Microsoft.VisualBasic.Strings.Chr(34) & "}"
