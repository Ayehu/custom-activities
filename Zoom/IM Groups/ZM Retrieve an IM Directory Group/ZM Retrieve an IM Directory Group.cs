...
{
    public class ZM_Retrieve_an_IM_Directory_Group : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public ZM_Retrieve_an_IM_Directory_Group() {
    }
    
    public ZM_Retrieve_an_IM_Directory_Group(string Jsonkeypath, string apikey, string password1, string groupId) {
