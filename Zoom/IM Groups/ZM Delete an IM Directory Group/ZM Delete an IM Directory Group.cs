...
{
    public class ZM_Delete_an_IM_Directory_Group : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public ZM_Delete_an_IM_Directory_Group() {
    }
    
    public ZM_Delete_an_IM_Directory_Group(string Jsonkeypath, string apikey, string password1, string groupId) {
