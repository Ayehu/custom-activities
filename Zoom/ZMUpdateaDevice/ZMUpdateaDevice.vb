...
Public assigned_to as string
        ...
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""display_name"" : " & Microsoft.VisualBasic.Strings.Chr(34) & display_name & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""mac_address"" : " & Microsoft.VisualBasic.Strings.Chr(34) & mac_address & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""assigned_to"" : " & Microsoft.VisualBasic.Strings.Chr(34) & assigned_to & Microsoft.VisualBasic.Strings.Chr(34) & "}"
            ...
            RequestURL="https://api.zoom.us/v2/phone/devices/" & deviceId & "?"& queryString.ToString()
