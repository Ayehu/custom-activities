...
Public hide_room_in_contacts as string
        ...
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""basic"": {    ""name"" : " & Microsoft.VisualBasic.Strings.Chr(34) & name1 & Microsoft.VisualBasic.Strings.Chr(34) & ",    ""support_email"" : " & Microsoft.VisualBasic.Strings.Chr(34) & support_email & Microsoft.VisualBasic.Strings.Chr(34) & ",    ""support_phone"" : " & Microsoft.VisualBasic.Strings.Chr(34) & support_phone & Microsoft.VisualBasic.Strings.Chr(34) & ",    ""room_passcode"" : " & Microsoft.VisualBasic.Strings.Chr(34) & room_passcode & Microsoft.VisualBasic.Strings.Chr(34) & ",    ""required_code_to_ext"" : " & required_code_to_ext & ",    ""hide_room_in_contacts"" : " & hide_room_in_contacts & "  }}"
            ...
            RequestURL="https://api.zoom.us/v2/rooms/" & roomId & "?"& queryString.ToString()
