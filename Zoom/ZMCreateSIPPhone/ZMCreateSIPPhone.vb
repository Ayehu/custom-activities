...
Public register_server as string
Public transport_protocol as string
Public proxy_server as string
Public register_server2 as string
Public transport_protocol2 as string
Public proxy_server2 as string
Public register_server3 as string
Public transport_protocol3 as string
Public proxy_server3 as string
Public registration_expire_time as string
Public user_name as string
Public password as string
Public authorization_name as string
Public user_email as string
Public voice_mail as string
        ...
        Dim TableName As String = "sip_phones"
        Public Async Function Execute() As System.Threading.Tasks.Task(Of ICustomActivityResult) Implements IActivityAsync.Execute
            ...
            Dim PostData As String = "{  ""user_email"" : " & Microsoft.VisualBasic.Strings.Chr(34) & user_email & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""domain"" : " & Microsoft.VisualBasic.Strings.Chr(34) & domain & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""register_server"" : " & Microsoft.VisualBasic.Strings.Chr(34) & register_server & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""transport_protocol"" : " & Microsoft.VisualBasic.Strings.Chr(34) & transport_protocol & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""proxy_server"" : " & Microsoft.VisualBasic.Strings.Chr(34) & proxy_server & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""registration_expire_time"" : " & registration_expire_time & ",  ""user_name"" : " & Microsoft.VisualBasic.Strings.Chr(34) & user_name & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""password"" : " & Microsoft.VisualBasic.Strings.Chr(34) & password & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""authorization_name"" : " & Microsoft.VisualBasic.Strings.Chr(34) & authorization_name & Microsoft.VisualBasic.Strings.Chr(34) & ",  ""voice_mail"" : " & Microsoft.VisualBasic.Strings.Chr(34) & voice_mail & Microsoft.VisualBasic.Strings.Chr(34) & "}"
            ...
            RequestURL="https://api.zoom.us/v2/sip_phones?"& queryString.ToString()
