...
namespace Ayehu.Sdk.ActivityCreation
{
	public class CustomActivity : IActivity
	{
		...
		public ICustomActivityResult Execute()
		{
			...
			ScriptCode = "New-Item '" + registryKey + ":\\" + registryPath + "' -Force";
			...
			try
			{
				...
				{
					ExecuteLocal(ScriptPath, ScriptCode, HasParams, TableAsString);

                    return this.GenerateActivityResult("Success");
				}
				else
				{
					ExecuteRemote(PowershellTimeOut, HostName, UserName, Password, PsrPort, UriType, ScriptCode, ScriptPath, HasParams.ToString(), TableAsString);
