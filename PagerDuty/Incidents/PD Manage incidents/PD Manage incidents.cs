...
{
    public class PD_Manage_incidents : IActivityAsync
    {
...
_postData = string.Format("{{ \"incidents\": {0} }}",incidents);
            }
return _postData;
        }
        set {
...
return _queryStringArray;
    ...
    public PD_Manage_incidents() {
    }
    
    public PD_Manage_incidents(string Jsonkeypath, string password1, string From, string incidents) {
