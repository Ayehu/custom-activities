...
{
    public class PD_Get_aggregated_service_data : IActivityAsync
    {
...
_uriBuilderPath = "/analytics/metrics/incidents/services";
            }
...
return _queryStringArray;
    ...
    public PD_Get_aggregated_service_data() {
    }
    
    public PD_Get_aggregated_service_data(string Jsonkeypath, string password1, string X_EARLY_ACCESS) {
