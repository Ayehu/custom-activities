...
{
    public class PD_Update_an_escalation_policy : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/escalation_policies/{0}",id_p);
            }
...
return _queryStringArray;
    ...
    public PD_Update_an_escalation_policy() {
    }
    
    public PD_Update_an_escalation_policy(string Jsonkeypath, string password1, string id_p, string type_p, string name_p, string description_p, string num_loops, string on_call_handoff_notifications, string escalation_rules, string services, string teams) {
