...
{
    public class PD_Delete_a_tag : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/tags/{0}",id_p);
            }
...
return _queryStringArray;
    ...
    public PD_Delete_a_tag() {
    }
    
    public PD_Delete_a_tag(string Jsonkeypath, string password1, string id_p) {
