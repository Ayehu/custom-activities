...
{
    public class PD_List_Event_Rules : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public PD_List_Event_Rules() {
    }
    
    public PD_List_Event_Rules(string Jsonkeypath, string password1, string total, string id_p) {
