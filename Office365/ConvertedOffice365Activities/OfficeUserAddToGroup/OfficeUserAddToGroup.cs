...
{
    public class OfficeUserAddToGroup : IActivity
    {
        /// <summary>
        ...
        private string uriBuilderPath
        {
            get
            {
                ...
                {
                    _uriBuilderPath = "/v1.0/groups/" + groupId + "/members/$ref";
                }
        ...
        public ICustomActivityResult Execute()
        {
            groupId = GetGroupId();
            userId = GetUserId();
            postData = @"{ ""@odata.id"": ""https://graph.microsoft.com/v1.0/directoryObjects/" + userId + @""" }";
