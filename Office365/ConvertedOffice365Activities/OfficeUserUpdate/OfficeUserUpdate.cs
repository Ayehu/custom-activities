...
{
    public class OfficeUserUpdate : IActivity
    {
        /// <summary>
        ...
        private string GetBody()
        {
            ...
            if (!string.IsNullOrEmpty(firstName))
                sb.AppendLine(@" ""givenName"": """ + firstName + @""", ");

            if (!string.IsNullOrEmpty(lastName))
                sb.AppendLine(@" ""surname"": """ + lastName + @""", ");

            if (!string.IsNullOrEmpty(firstName) && !string.IsNullOrEmpty(lastName))
                sb.AppendLine(@" ""DisplayName"": """ + firstName + " " + lastName + @""", ");

            if (!string.IsNullOrEmpty(password))
            {
                string pwdProfile = @" ""passwordProfile"": {
                                            ""forceChangePasswordNextSignIn"": false ,
                                            ""password"": """ + password + @"""
                                    }";
                sb.AppendLine(pwdProfile);
            }
