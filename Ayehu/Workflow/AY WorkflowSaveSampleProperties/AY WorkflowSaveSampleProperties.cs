...
{
    public class AY_WorkflowSaveSampleProperties : IActivityAsync
    {
...
_uriBuilderPath = "Server/Api/workflow/saveSampleProperties";
            }
...
return _queryStringArray;
    ...
    public AY_WorkflowSaveSampleProperties() {
    }
