...
{
    public class AY_GeneralGetAllConditions : IActivityAsync
    {
...
_uriBuilderPath = "Server/Api/General/getAllConditions";
            }
...
return _queryStringArray;
    ...
    public AY_GeneralGetAllConditions() {
    }
    
    public AY_GeneralGetAllConditions(string endPoint, string Jsonkeypath, string password1, string stringToSearch, string id_p, string lastModify, string pageSize, string pageNumber, string totalRecords, string sortDirection, string columnNameToSortBy, string deleted) {
