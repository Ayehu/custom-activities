...
{
    public class AY_GeneralGetAllTimeFrames : IActivityAsync
    {
...
_uriBuilderPath = "Server/Api/General/getAllTimeFrames";
            }
...
return _queryStringArray;
    ...
    public AY_GeneralGetAllTimeFrames() {
    }
    
    public AY_GeneralGetAllTimeFrames(string endPoint, string Jsonkeypath, string password1, string stringToSearch, string id_p, string lastModify, string pageSize, string pageNumber, string totalRecords, string sortDirection, string columnNameToSortBy, string deleted) {
