...
{
    public class AY_GeneralGetAllVariables : IActivityAsync
    {
...
_uriBuilderPath = "Server/Api/General/getAllVariables";
            }
...
return _queryStringArray;
    ...
    public AY_GeneralGetAllVariables() {
    }
    
    public AY_GeneralGetAllVariables(string endPoint, string Jsonkeypath, string password1, string stringToSearch, string id_p, string lastModify, string pageSize, string pageNumber, string totalRecords, string sortDirection, string columnNameToSortBy, string deleted) {
