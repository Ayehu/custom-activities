...
{
    public class AY_IncidentConfigurationUpdateIncidentNote : IActivityAsync
    {
...
_uriBuilderPath = "Server/API/IncidentConfiguration/updateIncidentNote";
            }
...
return _queryStringArray;
    ...
    public AY_IncidentConfigurationUpdateIncidentNote() {
    }
    
    public AY_IncidentConfigurationUpdateIncidentNote(string endPoint, string Jsonkeypath, string password1, string id_p, string name_p, string dateCreated, string dateModified, string authorId, string modifierId, string shortDescription, string longDescription, string state, string incidentNotesRankings) {
