...
{
    public class AY_IncidentConfigurationCreateIncidentService : IActivityAsync
    {
    ...
    public string Jsonkeypath = "createIncidentService";
...
_uriBuilderPath = "Server/API/IncidentConfiguration/createIncidentService";
            }
...
return _queryStringArray;
    ...
    public AY_IncidentConfigurationCreateIncidentService() {
    }
