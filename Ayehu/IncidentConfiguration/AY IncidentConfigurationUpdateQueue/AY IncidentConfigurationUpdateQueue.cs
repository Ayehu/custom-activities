...
{
    public class AY_IncidentConfigurationUpdateQueue : IActivityAsync
    {
    ...
    public string Jsonkeypath = "updateQueue";
...
_uriBuilderPath = "Server/API/IncidentConfiguration/updateQueue";
            }
...
return _queryStringArray;
    ...
    public AY_IncidentConfigurationUpdateQueue() {
    }
    
    public AY_IncidentConfigurationUpdateQueue(string endPoint, string Jsonkeypath, string password1, string id_p, string name_p, string host, string port, string external_host, string external_port, string userName, string password, string sshCertificate) {
