...
Namespace Ayehu.Sdk.ActivityCreation
    Public Class CustomActivity
        ...
        Public Function Execute() As ICustomActivityResult Implements IActivity.Execute
            ...
            Dim cm3 As New ReplaceWithNextAvailableTokenCommand
            cm3.tknGuid = targetguid
            cm3.setNewPin = True
            cm3.execute()

            Dim cm4 As New UnlinkTokensFromPrincipalsCommand
            cm4.tokenGuids = New String() {targetguid}
            cm4.execute()
