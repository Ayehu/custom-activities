...
{
    public class GH_GitHub_API_Root : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public GH_GitHub_API_Root() {
    }
    
    public GH_GitHub_API_Root(string Jsonkeypath, string Accept, string password1, string Username) {
