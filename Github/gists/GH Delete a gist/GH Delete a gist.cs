...
{
    public class GH_Delete_a_gist : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public GH_Delete_a_gist() {
    }
    
    public GH_Delete_a_gist(string Jsonkeypath, string Accept, string password1, string Username, string gist_id) {
