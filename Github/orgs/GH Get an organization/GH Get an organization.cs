...
{
    public class GH_Get_an_organization : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public GH_Get_an_organization() {
    }
    
    public GH_Get_an_organization(string Jsonkeypath, string Accept, string password1, string Username, string org) {
