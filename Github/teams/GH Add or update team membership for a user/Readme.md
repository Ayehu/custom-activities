<br>#     Github</br>
<br>Add or update team membership for a user</br>
...
**Note:** You can also specify a team by `org_id` and `team_id` using the route `PUT /organizations/{org_id}/team/{team_id}/memberships</br>
<br>Method: Put</br>
<br>OperationID: teams/add-or-update-membership-for-user-in-org</br>
<br>EndPoint:</br>
