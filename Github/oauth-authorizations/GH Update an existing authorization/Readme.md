<br>#     Github</br>
<br>Update an existing authorization</br>
...
You can only send one of these scope keys at a time.</br>
<br>Method: Patch</br>
<br>OperationID: oauth-authorizations/update-authorization</br>
<br>EndPoint:</br>
<br>/authorizations/{authorization_id}</br>
