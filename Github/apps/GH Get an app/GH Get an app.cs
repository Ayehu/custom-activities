...
{
    public class GH_Get_an_app : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/apps/{0}",app_slug);
            }
...
return _queryStringArray;
    ...
    public GH_Get_an_app() {
    }
    
    public GH_Get_an_app(string Jsonkeypath, string Accept, string password1, string Username, string app_slug) {
