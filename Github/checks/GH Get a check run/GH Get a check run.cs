...
{
    public class GH_Get_a_check_run : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public GH_Get_a_check_run() {
    }
    
    public GH_Get_a_check_run(string Jsonkeypath, string Accept, string password1, string Username, string owner, string repo, string check_run_id) {
