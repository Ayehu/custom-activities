...
{
    public class GH_Get_a_repository : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public GH_Get_a_repository() {
    }
    
    public GH_Get_a_repository(string Jsonkeypath, string Accept, string password1, string Username, string owner, string repo) {
