...
{
    public class GH_Delete_a_repository : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public GH_Delete_a_repository() {
    }
    
    public GH_Delete_a_repository(string Jsonkeypath, string Accept, string password1, string Username, string owner, string repo) {
