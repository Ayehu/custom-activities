...
{
    public class GH_Delete_branch_protection : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public GH_Delete_branch_protection() {
    }
    
    public GH_Delete_branch_protection(string Jsonkeypath, string Accept, string password1, string Username, string owner, string repo, string branch) {
