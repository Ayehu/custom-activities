...
{
    public class GH_Create_a_repository_for_the_authenticated_user : IActivityAsync
    {
...
_postData = string.Format("{{ \"name\": \"{0}\",  \"description\": \"{1}\",  \"homepage\": \"{2}\",  \"private\": \"{3}\",  \"has_issues\": \"{4}\",  \"has_projects\": \"{5}\",  \"has_wiki\": \"{6}\",  \"team_id\": \"{7}\",  \"auto_init\": \"{8}\",  \"gitignore_template\": \"{9}\",  \"license_template\": \"{10}\",  \"allow_squash_merge\": \"{11}\",  \"allow_merge_commit\": \"{12}\",  \"allow_rebase_merge\": \"{13}\",  \"delete_branch_on_merge\": \"{14}\",  \"has_downloads\": \"{15}\",  \"is_template\": \"{16}\" }}",name_p,description_p,homepage,private,has_issues,has_projects,has_wiki,team_id,auto_init,gitignore_template,license_template,allow_squash_merge,allow_merge_commit,allow_rebase_merge,delete_branch_on_merge,has_downloads,is_template);
            }
return _postData;
        }
        set {
...
return _queryStringArray;
    ...
    public GH_Create_a_repository_for_the_authenticated_user() {
    }
