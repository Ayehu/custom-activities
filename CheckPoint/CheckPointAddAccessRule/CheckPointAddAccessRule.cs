...
{
    public class CheckPointAddAccessRule : IActivity
    {
        #region Private readonly properties

        private readonly string API_REQUEST_URL = "{0}:443/web_api/add-access-rule";
        ...
        private string IncidentJsonBuilder()
        {
            ...
            incidentJson.Append(Layer);
            incidentJson.Append("\",\"position\": \"");
            incidentJson.Append(Position);
            incidentJson.Append("\",\"name\": \"");
            incidentJson.Append(Name);
            incidentJson.Append("\"}");
