...
{
    public class LM_get_datasource_overview_graph_list : IActivityAsync
    {
    ...
    public string Jsonkeypath = "ographs";
...
_uriBuilderPath = string.Format("/setting/datasources/{0}/ographs",dsId);
            }
...
return _queryStringArray;
    ...
    public LM_get_datasource_overview_graph_list() {
    }
    
    public LM_get_datasource_overview_graph_list(string endPoint, string Jsonkeypath, string accessid, string password1, string dsId, string fields, string size, string offset, string filter) {
