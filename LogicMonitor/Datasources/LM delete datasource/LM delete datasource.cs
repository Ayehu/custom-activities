...
{
    public class LM_delete_datasource : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_delete_datasource() {
    }
    
    public LM_delete_datasource(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p) {
