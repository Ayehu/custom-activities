...
{
    public class LM_import_datasource_via_xml : IActivityAsync
    {
...
_uriBuilderPath = "/setting/datasources/importxml";
            }
...
return _queryStringArray;
    ...
    public LM_import_datasource_via_xml() {
    }
    
    public LM_import_datasource_via_xml(string endPoint, string Jsonkeypath, string accessid, string password1, string file) {
