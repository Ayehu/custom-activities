...
{
    public class LM_get_update_history_for_a_datasource : IActivityAsync
    {
    ...
    public string Jsonkeypath = "updatereasons";
...
_uriBuilderPath = string.Format("/setting/datasources/{0}/updatereasons",id_p);
            }
...
return _queryStringArray;
    ...
    public LM_get_update_history_for_a_datasource() {
    }
    
    public LM_get_update_history_for_a_datasource(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p, string fields, string size, string offset, string filter) {
