...
{
    public class LM_get_datasource_overview_graph_by_id : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/setting/datasources/{0}/ographs/{1}",dsId,id_p);
            }
...
return _queryStringArray;
    ...
    public LM_get_datasource_overview_graph_by_id() {
    }
    
    public LM_get_datasource_overview_graph_by_id(string endPoint, string Jsonkeypath, string accessid, string password1, string dsId, string id_p) {
