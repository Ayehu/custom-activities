...
{
    public class LM_get_devices_associated_with_a_datasource : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/setting/datasources/{0}/devices",id_p);
            }
...
return _queryStringArray;
    ...
    public LM_get_devices_associated_with_a_datasource() {
    }
    
    public LM_get_devices_associated_with_a_datasource(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p, string fields, string size, string offset, string filter) {
