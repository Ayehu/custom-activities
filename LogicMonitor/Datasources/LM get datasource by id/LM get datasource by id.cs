...
{
    public class CustomActivity_LM_get_datasource_by_id : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("/setting/datasources/{0}",id_p);
        }
    }
    ...
    private System.Collections.Generic.Dictionary<string, string> queryStringArray {
        get {
            return new Dictionary<string, string>() {{"format",format},{"fields",fields}};
        }
    }
