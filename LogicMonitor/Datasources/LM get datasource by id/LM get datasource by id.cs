...
{
    public class LM_get_datasource_by_id : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/setting/datasources/{0}",id_p);
            }
...
_queryStringArray = new Dictionary<string, string>() { {"format",format},{"fields",fields} };
            }
return _queryStringArray;
    ...
    public LM_get_datasource_by_id() {
    }
    
    public LM_get_datasource_by_id(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p, string format, string fields) {
