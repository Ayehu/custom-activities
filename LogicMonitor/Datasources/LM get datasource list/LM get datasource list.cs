...
{
    public class LM_get_datasource_list : IActivityAsync
    {
...
_uriBuilderPath = "/setting/datasources";
            }
...
return _queryStringArray;
    ...
    public LM_get_datasource_list() {
    }
    
    public LM_get_datasource_list(string endPoint, string Jsonkeypath, string accessid, string password1, string format, string fields, string size, string offset, string filter) {
