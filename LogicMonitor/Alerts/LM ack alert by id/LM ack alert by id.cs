...
{
    public class LM_ack_alert_by_id : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/alert/alerts/{0}/ack",id_p);
            }
...
_postData = string.Format("{{ \"ackComment\": \"{0}\" }}",ackComment);
            }
return _postData;
        }
        set {
...
return _queryStringArray;
    ...
    public LM_ack_alert_by_id() {
    }
    
    public LM_ack_alert_by_id(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p, string ackComment) {
