...
{
    public class LM_add_alert_note : IActivityAsync
    {
    ...
    public string Jsonkeypath = "note";
...
_uriBuilderPath = string.Format("/alert/alerts/{0}/note",id_p);
            }
...
return _queryStringArray;
    ...
    public LM_add_alert_note() {
    }
    
    public LM_add_alert_note(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p, string ackComment) {
