...
{
    public class CustomActivity_LM_get_alert : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("/alert/alerts/{0}",id_p);
        }
    }
    ...
    private System.Collections.Generic.Dictionary<string, string> queryStringArray {
        get {
            return new Dictionary<string, string>() {{"needMessage",needMessage},{"customColumns",customColumns},{"fields",fields}};
        }
    }
