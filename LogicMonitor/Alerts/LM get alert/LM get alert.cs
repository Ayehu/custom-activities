...
{
    public class LM_get_alert : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/alert/alerts/{0}",id_p);
            }
...
_queryStringArray = new Dictionary<string, string>() { {"needMessage",needMessage},{"customColumns",customColumns},{"fields",fields} };
            }
return _queryStringArray;
    ...
    public LM_get_alert(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p, string needMessage, string customColumns, string fields) {
