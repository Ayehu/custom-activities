...
{
    public class CustomActivity_LM_get_alert_list : IActivityAsync
    {
    ...
    private System.Collections.Generic.Dictionary<string, string> queryStringArray {
        get {
            return new Dictionary<string, string>() {{"customColumns",customColumns},{"fields",fields},{"size",size},{"offset",offset},{"filter",filter}};
        }
    }
