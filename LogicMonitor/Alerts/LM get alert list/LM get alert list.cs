...
{
    public class LM_get_alert_list : IActivityAsync
    {
...
_queryStringArray = new Dictionary<string, string>() { {"customColumns",customColumns},{"fields",fields},{"size",size},{"offset",offset},{"filter",filter} };
            }
return _queryStringArray;
    ...
    public LM_get_alert_list() {
    }
    
    public LM_get_alert_list(string endPoint, string Jsonkeypath, string accessid, string password1, string customColumns, string fields, string size, string offset, string filter) {
