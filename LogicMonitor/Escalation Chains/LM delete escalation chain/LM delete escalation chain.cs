...
{
    public class LM_delete_escalation_chain : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_delete_escalation_chain() {
    }
    
    public LM_delete_escalation_chain(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p) {
