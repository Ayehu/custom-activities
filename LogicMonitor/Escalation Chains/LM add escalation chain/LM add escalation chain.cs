...
{
    public class LM_add_escalation_chain : IActivityAsync
    {
...
_uriBuilderPath = "/setting/alert/chains";
            }
...
return _queryStringArray;
    ...
    public LM_add_escalation_chain() {
    }
    
    public LM_add_escalation_chain(string endPoint, string Jsonkeypath, string accessid, string password1, string ccDestinations, string description_p, string destinations, string enableThrottling, string name_p, string throttlingAlerts, string throttlingPeriod) {
