...
{
    public class LM_delete_role : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_delete_role() {
    }
    
    public LM_delete_role(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p) {
