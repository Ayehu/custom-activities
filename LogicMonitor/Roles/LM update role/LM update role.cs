...
{
    public class LM_update_role : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/setting/roles/{0}",id_p);
            }
...
return _queryStringArray;
    ...
    public LM_update_role() {
    }
    
    public LM_update_role(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p, string customHelpLabel, string customHelpURL, string description_p, string name_p, string privileges, string requireEULA, string twoFARequired) {
