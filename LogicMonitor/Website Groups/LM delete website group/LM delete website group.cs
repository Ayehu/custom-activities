...
{
    public class LM_delete_website_group : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_delete_website_group() {
    }
    
    public LM_delete_website_group(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p, string deleteChildren) {
