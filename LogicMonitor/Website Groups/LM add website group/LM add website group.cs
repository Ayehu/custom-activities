...
{
    public class LM_add_website_group : IActivityAsync
    {
...
_uriBuilderPath = "/website/groups";
            }
...
return _queryStringArray;
    ...
    public LM_add_website_group() {
    }
    
    public LM_add_website_group(string endPoint, string Jsonkeypath, string accessid, string password1, string description_p, string disableAlerting, string name_p, string parentId, string properties, string stopMonitoring, string all) {
