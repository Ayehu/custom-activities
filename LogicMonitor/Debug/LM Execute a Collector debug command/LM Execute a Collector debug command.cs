...
{
    public class LM_Execute_a_Collector_debug_command : IActivityAsync
    {
    ...
    public string Jsonkeypath = "debug";
...
_postData = string.Format("{{ \"cmdContext\": \"{0}\",  \"cmdline\": \"{1}\" }}",cmdContext,cmdline);
            }
return _postData;
        }
        set {
...
return _queryStringArray;
    ...
    public LM_Execute_a_Collector_debug_command() {
    }
    
    public LM_Execute_a_Collector_debug_command(string endPoint, string Jsonkeypath, string accessid, string password1, string cmdContext, string cmdline) {
