...
{
    public class CustomActivity_LM_Get_the_result_of_a_Collector_debug_command : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("/debug/{0}",id_p);
        }
    }
    ...
    private System.Collections.Generic.Dictionary<string, string> queryStringArray {
        get {
            return new Dictionary<string, string>() {{"collectorId",collectorId}};
        }
    }
