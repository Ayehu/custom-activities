...
{
    public class LM_update_api_tokens_for_a_user : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/setting/admins/{0}/apitokens/{1}",adminId,apitokenId);
            }
...
return _queryStringArray;
    ...
    public LM_update_api_tokens_for_a_user() {
    }
    
    public LM_update_api_tokens_for_a_user(string endPoint, string Jsonkeypath, string accessid, string password1, string adminId, string apitokenId, string note, string status) {
