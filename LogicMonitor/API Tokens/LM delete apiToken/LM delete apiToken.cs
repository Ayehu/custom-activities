...
{
    public class LM_delete_apiToken : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_delete_apiToken() {
    }
    
    public LM_delete_apiToken(string endPoint, string Jsonkeypath, string accessid, string password1, string adminId, string apitokenId) {
