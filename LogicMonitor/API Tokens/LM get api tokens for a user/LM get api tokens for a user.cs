...
{
    public class LM_get_api_tokens_for_a_user : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_get_api_tokens_for_a_user() {
    }
    
    public LM_get_api_tokens_for_a_user(string endPoint, string Jsonkeypath, string accessid, string password1, string adminId, string fields, string size, string offset, string filter) {
