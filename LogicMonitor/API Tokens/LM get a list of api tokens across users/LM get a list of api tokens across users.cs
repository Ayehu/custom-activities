...
{
    public class LM_get_a_list_of_api_tokens_across_users : IActivityAsync
    {
    ...
    public string Jsonkeypath = "apitokens";
...
_uriBuilderPath = "/setting/admins/apitokens";
            }
...
return _queryStringArray;
    ...
    public LM_get_a_list_of_api_tokens_across_users() {
    }
    
    public LM_get_a_list_of_api_tokens_across_users(string endPoint, string Jsonkeypath, string accessid, string password1, string fields, string size, string offset, string filter) {
