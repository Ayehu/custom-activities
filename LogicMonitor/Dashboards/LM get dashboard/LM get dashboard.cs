...
{
    public class LM_get_dashboard : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_get_dashboard() {
    }
    
    public LM_get_dashboard(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p, string template, string format, string fields) {
