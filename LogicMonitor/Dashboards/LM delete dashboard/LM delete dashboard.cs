...
{
    public class LM_delete_dashboard : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_delete_dashboard() {
    }
    
    public LM_delete_dashboard(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p) {
