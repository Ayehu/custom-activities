...
{
    public class LM_get_widget_list_by_DashboardId : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/dashboard/dashboards/{0}/widgets",id_p);
            }
...
return _queryStringArray;
    ...
    public LM_get_widget_list_by_DashboardId() {
    }
    
    public LM_get_widget_list_by_DashboardId(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p, string fields, string size, string offset, string filter) {
