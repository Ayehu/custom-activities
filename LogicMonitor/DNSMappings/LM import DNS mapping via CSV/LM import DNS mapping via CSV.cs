...
{
    public class LM_import_DNS_mapping_via_CSV : IActivityAsync
    {
    ...
    public string Jsonkeypath = "dnsmappings";
...
_uriBuilderPath = "/setting/dnsmappings";
            }
...
return _queryStringArray;
    ...
    public LM_import_DNS_mapping_via_CSV() {
    }
    
    public LM_import_DNS_mapping_via_CSV(string endPoint, string Jsonkeypath, string accessid, string password1, string file) {
