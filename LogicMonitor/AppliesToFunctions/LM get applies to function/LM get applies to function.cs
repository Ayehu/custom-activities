...
{
    public class LM_get_applies_to_function : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_get_applies_to_function() {
    }
    
    public LM_get_applies_to_function(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p) {
