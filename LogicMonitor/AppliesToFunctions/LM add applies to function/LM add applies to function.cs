...
{
    public class LM_add_applies_to_function : IActivityAsync
    {
    ...
    public string Jsonkeypath = "functions";
...
_uriBuilderPath = "/setting/functions";
            }
...
return _queryStringArray;
    ...
    public LM_add_applies_to_function() {
    }
    
    public LM_add_applies_to_function(string endPoint, string Jsonkeypath, string accessid, string password1, string code, string description_p, string name_p) {
