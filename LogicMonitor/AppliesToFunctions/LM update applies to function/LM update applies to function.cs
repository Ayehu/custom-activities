...
{
    public class LM_update_applies_to_function : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/setting/functions/{0}",id_p);
            }
...
_postData = string.Format("{{ \"code\": \"{0}\",  \"description\": \"{1}\",  \"name\": \"{2}\" }}",code,description_p,name_p);
            }
return _postData;
        }
        set {
...
return _queryStringArray;
    ...
    public LM_update_applies_to_function() {
    }
    
    public LM_update_applies_to_function(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p, string code, string description_p, string name_p) {
