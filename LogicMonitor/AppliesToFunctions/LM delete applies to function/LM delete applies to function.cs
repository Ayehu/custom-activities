...
{
    public class LM_delete_applies_to_function : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_delete_applies_to_function() {
    }
    
    public LM_delete_applies_to_function(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p, string ignoreReference) {
