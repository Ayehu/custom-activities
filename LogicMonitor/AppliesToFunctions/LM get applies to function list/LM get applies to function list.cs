...
{
    public class LM_get_applies_to_function_list : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_get_applies_to_function_list() {
    }
    
    public LM_get_applies_to_function_list(string endPoint, string Jsonkeypath, string accessid, string password1, string fields, string size, string offset, string filter) {
