...
{
    public class LM_get_dashboard_group : IActivityAsync
    {
...
_queryStringArray = new Dictionary<string, string>() { {"template",template},{"format",format},{"fields",fields} };
            }
return _queryStringArray;
    ...
    public LM_get_dashboard_group() {
    }
    
    public LM_get_dashboard_group(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p, string template, string format, string fields) {
