...
{
    public class LM_update_dashboard_group : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/dashboard/groups/{0}",id_p);
            }
...
_postData = string.Format("{{ \"description\": \"{0}\",  \"name\": \"{1}\",  \"parentId\": \"{2}\",  \"widgetTokens\": {3} }}",description_p,name_p,parentId,widgetTokens);
            }
return _postData;
        }
        set {
...
return _queryStringArray;
    ...
    public LM_update_dashboard_group() {
    }
    
    public LM_update_dashboard_group(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p, string description_p, string name_p, string parentId, string widgetTokens) {
