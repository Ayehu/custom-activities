...
{
    public class LM_add_dashboard_group : IActivityAsync
    {
...
_uriBuilderPath = "/dashboard/groups";
            }
...
return _queryStringArray;
    ...
    public LM_add_dashboard_group() {
    }
    
    public LM_add_dashboard_group(string endPoint, string Jsonkeypath, string accessid, string password1, string description_p, string name_p, string parentId, string widgetTokens) {
