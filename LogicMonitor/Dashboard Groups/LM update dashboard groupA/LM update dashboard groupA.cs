...
{
    public class CustomActivity_LM_update_dashboard_groupA : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("/dashboard/groups/{0}",id_p);
        }
    }
    
    private string postData {
        get {
            return string.Format("{{ \"description\": \"{0}\",  \"name\": \"{1}\",  \"parentId\": \"{2}\",  \"widgetTokens\": [    {{     \"name\": \"{3}\",      \"value\": \"{4}\"     }}  ] }}",description,name_p,parentId,widgetTokens_name,value);
        }
    }
