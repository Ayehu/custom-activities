...
{
    public class LM_delete_dashboard_group : IActivityAsync
    {
    ...
    public string allowNonEmptyGroup = "";
...
return _queryStringArray;
    ...
    public LM_delete_dashboard_group() {
    }
    
    public LM_delete_dashboard_group(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p, string allowNonEmptyGroup) {
        this.endPoint = endPoint;
        this.Jsonkeypath = Jsonkeypath;
        this.accessid = accessid;
        this.password1 = password1;
        this.id_p = id_p;
        this.allowNonEmptyGroup = allowNonEmptyGroup;
    }
