...
{
    public class LM_Get_audit_log_by_id : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/setting/accesslogs/{0}",id_p);
            }
...
return _queryStringArray;
    ...
    public LM_Get_audit_log_by_id() {
    }
    
    public LM_Get_audit_log_by_id(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p) {
