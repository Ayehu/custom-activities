...
{
    public class LM_Get_audit_logs : IActivityAsync
    {
    ...
    public string Jsonkeypath = "accesslogs";
...
_uriBuilderPath = "/setting/accesslogs";
            }
...
return _queryStringArray;
    ...
    public LM_Get_audit_logs() {
    }
    
    public LM_Get_audit_logs(string endPoint, string Jsonkeypath, string accessid, string password1, string format, string fields, string size, string offset, string filter) {
