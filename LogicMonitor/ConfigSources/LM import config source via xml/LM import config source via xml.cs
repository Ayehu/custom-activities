...
{
    public class LM_import_config_source_via_xml : IActivityAsync
    {
    ...
    public string Jsonkeypath = "importxml";
...
_uriBuilderPath = "/setting/configsources/importxml";
            }
...
_postData = string.Format("{{ \"file\": \"{0}\" }}",file);
            }
return _postData;
        }
        set {
...
return _queryStringArray;
    ...
    public LM_import_config_source_via_xml() {
    }
    
    public LM_import_config_source_via_xml(string endPoint, string Jsonkeypath, string accessid, string password1, string file) {
