...
{
    public class CustomActivity_LM_add_widget : IActivityAsync
    {
    ...
    private string postData {
        get {
            return string.Format("{{ \"dashboardId\": \"{0}\",  \"description\": \"{1}\",  \"id\": \"{2}\",  \"interval\": \"{3}\",  \"name\": \"{4}\",  \"theme\": \"{5}\",  \"timescale\": \"{6}\",  \"type\": \"{7}\" }}",dashboardId,description,id_p,interval,name_p,theme,timescale,type);
        }
    }
