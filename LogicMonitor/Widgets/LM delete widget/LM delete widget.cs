...
{
    public class LM_delete_widget : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_delete_widget() {
    }
    
    public LM_delete_widget(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p) {
