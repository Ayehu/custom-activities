...
{
    public class LM_update_report_group : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/report/groups/{0}",id_p);
            }
...
_postData = string.Format("{{ \"description\": \"{0}\",  \"id\": \"{1}\",  \"name\": \"{2}\",  \"reportsCount\": \"{3}\",  \"userPermission\": \"{4}\" }}",description_p,_id,name_p,reportsCount,userPermission);
            }
return _postData;
        }
        set {
...
return _queryStringArray;
    ...
    public LM_update_report_group() {
    }
    
    public LM_update_report_group(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p, string description_p, string _id, string name_p, string reportsCount, string userPermission) {
