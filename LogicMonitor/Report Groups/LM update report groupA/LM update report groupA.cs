...
{
    public class CustomActivity_LM_update_report_groupA : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("/report/groups/{0}",id_p);
        }
    }
    
    private string postData {
        get {
            return string.Format("{{ \"description\": \"{0}\",  \"id\": \"{1}\",  \"name\": \"{2}\",  \"reportsCount\": \"{3}\",  \"userPermission\": \"{4}\" }}",description,_id,name_p,reportsCount,userPermission);
        }
    }
