...
{
    public class LM_get_user : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_get_user(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p, string fields) {
