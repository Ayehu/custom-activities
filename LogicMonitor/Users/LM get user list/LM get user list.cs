...
{
    public class LM_get_user_list : IActivityAsync
    {
    ...
    public string Jsonkeypath = "admins";
...
return _queryStringArray;
    ...
    public LM_get_user_list() {
    }
    
    public LM_get_user_list(string endPoint, string Jsonkeypath, string accessid, string password1, string fields, string size, string offset, string filter) {
