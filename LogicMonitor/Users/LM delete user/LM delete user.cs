...
{
    public class LM_delete_user : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_delete_user() {
    }
    
    public LM_delete_user(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p) {
