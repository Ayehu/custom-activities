...
{
    public class LM_get_metrics_usage : IActivityAsync
    {
    ...
    public string Jsonkeypath = "usage";
...
return _queryStringArray;
    ...
    public LM_get_metrics_usage() {
    }
    
    public LM_get_metrics_usage(string endPoint, string Jsonkeypath, string accessid, string password1) {
