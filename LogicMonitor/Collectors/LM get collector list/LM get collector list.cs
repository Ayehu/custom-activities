...
{
    public class LM_get_collector_list : IActivityAsync
    {
    ...
    public string Jsonkeypath = "collectors";
...
_uriBuilderPath = "/setting/collector/collectors";
            }
...
return _queryStringArray;
    ...
    public LM_get_collector_list() {
    }
    
    public LM_get_collector_list(string endPoint, string Jsonkeypath, string accessid, string password1, string fields, string size, string offset, string filter) {
