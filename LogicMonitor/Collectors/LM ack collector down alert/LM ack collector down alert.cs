...
{
    public class LM_ack_collector_down_alert : IActivityAsync
    {
    ...
    public string Jsonkeypath = "ackdown";
...
_uriBuilderPath = string.Format("/setting/collector/collectors/{0}/ackdown",id_p);
            }
...
_postData = string.Format("{{ \"comment\": \"{0}\" }}",comment);
            }
return _postData;
        }
        set {
...
return _queryStringArray;
    ...
    public LM_ack_collector_down_alert() {
    }
    
    public LM_ack_collector_down_alert(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p, string comment) {
