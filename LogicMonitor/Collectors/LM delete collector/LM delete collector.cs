...
{
    public class LM_delete_collector : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_delete_collector() {
    }
    
    public LM_delete_collector(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p) {
