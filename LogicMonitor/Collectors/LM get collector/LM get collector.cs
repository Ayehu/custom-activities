...
{
    public class LM_get_collector : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_get_collector() {
    }
    
    public LM_get_collector(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p, string fields) {
