...
{
    public class LM_get_device_group_alerts : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/device/groups/{0}/alerts",id_p);
            }
...
return _queryStringArray;
    ...
    public LM_get_device_group_alerts() {
    }
    
    public LM_get_device_group_alerts(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p, string needMessage, string customColumns, string fields, string size, string offset, string filter) {
