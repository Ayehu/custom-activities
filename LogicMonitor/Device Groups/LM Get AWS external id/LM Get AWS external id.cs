...
{
    public class LM_Get_AWS_external_id : IActivityAsync
    {
    ...
    public string Jsonkeypath = "externalId";
...
_uriBuilderPath = "/aws/externalId";
            }
...
return _queryStringArray;
    ...
    public LM_Get_AWS_external_id() {
    }
    
    public LM_Get_AWS_external_id(string endPoint, string Jsonkeypath, string accessid, string password1) {
