...
{
    public class LM_get_SDT_history_for_the_group : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/device/groups/{0}/historysdts",id_p);
            }
...
return _queryStringArray;
    ...
    public LM_get_SDT_history_for_the_group() {
    }
    
    public LM_get_SDT_history_for_the_group(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p, string fields, string size, string offset, string filter) {
