...
{
    public class LM_update_device_group_datasource : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/device/groups/{0}/datasources/{1}",deviceGroupId,id_p);
            }
...
_postData = string.Format("{{ \"stopMonitoring\": \"{0}\" }}",stopMonitoring);
            }
return _postData;
        }
        set {
...
return _queryStringArray;
    ...
    public LM_update_device_group_datasource() {
    }
    
    public LM_update_device_group_datasource(string endPoint, string Jsonkeypath, string accessid, string password1, string deviceGroupId, string id_p, string stopMonitoring) {
