...
{
    public class LM_add_device_group_property : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_add_device_group_property() {
    }
    
    public LM_add_device_group_property(string endPoint, string Jsonkeypath, string accessid, string password1, string gid, string body) {
