...
{
    public class LM_get_device_group_property_by_name : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/device/groups/{0}/properties/{1}",gid,name_p);
            }
...
return _queryStringArray;
    ...
    public LM_get_device_group_property_by_name() {
    }
    
    public LM_get_device_group_property_by_name(string endPoint, string Jsonkeypath, string accessid, string password1, string gid, string name_p, string fields) {
