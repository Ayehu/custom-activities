...
{
    public class LM_get_device_group_datasource : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_get_device_group_datasource() {
    }
    
    public LM_get_device_group_datasource(string endPoint, string Jsonkeypath, string accessid, string password1, string deviceGroupId, string id_p, string fields) {
