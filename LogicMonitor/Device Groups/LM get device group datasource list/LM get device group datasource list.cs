...
{
    public class CustomActivity_LM_get_device_group_datasource_list : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("/device/groups/{0}/datasources",deviceGroupId);
        }
    }
    ...
    private System.Collections.Generic.Dictionary<string, string> queryStringArray {
        get {
            return new Dictionary<string, string>() {{"includeDisabledDataSourceWithoutInstance",includeDisabledDataSourceWithoutInstance},{"fields",fields},{"size",size},{"offset",offset},{"filter",filter}};
        }
    }
