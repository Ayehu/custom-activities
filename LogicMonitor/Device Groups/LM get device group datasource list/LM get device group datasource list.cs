...
{
    public class LM_get_device_group_datasource_list : IActivityAsync
    {
    ...
    public string Jsonkeypath = "datasources";
    ...
    public string includeDisabledDataSourceWithoutInstance = "";
...
_uriBuilderPath = string.Format("/device/groups/{0}/datasources",deviceGroupId);
            }
...
_queryStringArray = new Dictionary<string, string>() { {"includeDisabledDataSourceWithoutInstance",includeDisabledDataSourceWithoutInstance},{"fields",fields},{"size",size},{"offset",offset},{"filter",filter} };
            }
return _queryStringArray;
    ...
    public LM_get_device_group_datasource_list() {
    }
    
    public LM_get_device_group_datasource_list(string endPoint, string Jsonkeypath, string accessid, string password1, string deviceGroupId, string includeDisabledDataSourceWithoutInstance, string fields, string size, string offset, string filter) {
        this.endPoint = endPoint;
        this.Jsonkeypath = Jsonkeypath;
        this.accessid = accessid;
        this.password1 = password1;
        this.deviceGroupId = deviceGroupId;
        this.includeDisabledDataSourceWithoutInstance = includeDisabledDataSourceWithoutInstance;
        this.fields = fields;
        this.size = size;
        this.offset = offset;
        this.filter = filter;
