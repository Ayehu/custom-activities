...
{
    public class LM_get_device_group_properties : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/device/groups/{0}/properties",gid);
            }
...
return _queryStringArray;
    ...
    public LM_get_device_group_properties() {
    }
    
    public LM_get_device_group_properties(string endPoint, string Jsonkeypath, string accessid, string password1, string gid, string fields, string size, string offset, string filter) {
