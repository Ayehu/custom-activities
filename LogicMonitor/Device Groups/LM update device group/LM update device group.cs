...
{
    public class LM_update_device_group : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/device/groups/{0}",id_p);
            }
...
return _queryStringArray;
    ...
    public LM_update_device_group(
                ...
                string gcpTestResult_detailLink, 
                string groupType, 
                string _name, 
                string parentId) {
