...
{
    public class LM_delete_device_group : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_delete_device_group() {
    }
    
    public LM_delete_device_group(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p, string deleteChildren, string deleteHard) {
