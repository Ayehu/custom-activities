...
{
    public class LM_get_device_group : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_get_device_group() {
    }
    
    public LM_get_device_group(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p, string fields) {
