...
{
    public class LM_get_device_group_list : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_get_device_group_list() {
    }
    
    public LM_get_device_group_list(string endPoint, string Jsonkeypath, string accessid, string password1, string fields, string size, string offset, string filter) {
