...
{
    public class CustomActivity_LM_update_device_group_datasourceA : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("/device/groups/{0}/datasources/{1}",deviceGroupId,id_p);
        }
    }
    
    private string postData {
        get {
            return string.Format("{{ \"stopMonitoring\": \"{0}\" }}",stopMonitoring);
        }
    }
