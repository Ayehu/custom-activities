...
{
    public class LM_update_device_datasource_instance_group : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/device/devices/{0}/devicedatasources/{1}/groups/{2}",deviceId,deviceDsId,id_p);
            }
...
return _queryStringArray;
    ...
    public LM_update_device_datasource_instance_group() {
    }
    
    public LM_update_device_datasource_instance_group(string endPoint, string Jsonkeypath, string accessid, string password1, string deviceId, string deviceDsId, string id_p, string description_p, string name_p) {
