...
{
    public class LM_getDeviceConfigSourceConfigList : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/device/devices/{0}/devicedatasources/{1}/instances/{2}/config",deviceId,hdsId,instanceId);
            }
...
return _queryStringArray;
    ...
    public LM_getDeviceConfigSourceConfigList() {
    }
    
    public LM_getDeviceConfigSourceConfigList(string endPoint, string Jsonkeypath, string accessid, string password1, string deviceId, string hdsId, string instanceId, string fields, string size, string offset, string filter) {
