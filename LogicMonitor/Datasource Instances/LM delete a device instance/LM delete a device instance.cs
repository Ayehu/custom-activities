...
{
    public class LM_delete_a_device_instance : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_delete_a_device_instance() {
    }
    
    public LM_delete_a_device_instance(string endPoint, string Jsonkeypath, string accessid, string password1, string deviceId, string hdsId, string id_p) {
