...
{
    public class LM_get_device_instance_SDT_history : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/device/devices/{0}/devicedatasources/{1}/instances/{2}/historysdts",deviceId,hdsId,id_p);
            }
...
return _queryStringArray;
    ...
    public LM_get_device_instance_SDT_history() {
    }
    
    public LM_get_device_instance_SDT_history(string endPoint, string Jsonkeypath, string accessid, string password1, string deviceId, string hdsId, string id_p, string fields, string size, string offset, string filter) {
