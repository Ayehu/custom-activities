...
{
    public class LM_get_device_instance : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_get_device_instance() {
    }
    
    public LM_get_device_instance(string endPoint, string Jsonkeypath, string accessid, string password1, string deviceId, string hdsId, string id_p, string fields) {
