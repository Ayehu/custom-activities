...
{
    public class LM_add_device_datasource_instance_group : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/device/devices/{0}/devicedatasources/{1}/groups",deviceId,deviceDsId);
            }
...
_postData = string.Format("{{ \"description\": \"{0}\",  \"name\": \"{1}\" }}",description_p,name_p);
            }
return _postData;
        }
        set {
...
return _queryStringArray;
    ...
    public LM_add_device_datasource_instance_group() {
    }
    
    public LM_add_device_datasource_instance_group(string endPoint, string Jsonkeypath, string accessid, string password1, string deviceId, string deviceDsId, string description_p, string name_p) {
