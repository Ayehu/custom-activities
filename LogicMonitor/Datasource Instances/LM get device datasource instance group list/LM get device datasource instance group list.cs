...
{
    public class CustomActivity_LM_get_device_datasource_instance_group_list : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("/device/devices/{0}/devicedatasources/{1}/groups",deviceId,deviceDsId);
        }
    }
    ...
    private System.Collections.Generic.Dictionary<string, string> queryStringArray {
        get {
            return new Dictionary<string, string>() {{"fields",fields},{"size",size},{"offset",offset},{"filter",filter}};
        }
    }
