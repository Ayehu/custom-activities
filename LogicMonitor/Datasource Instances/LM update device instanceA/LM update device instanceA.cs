...
{
    public class CustomActivity_LM_update_device_instanceA : IActivityAsync
    {
    ...
    public string autoProperties__ = "";
    ...
    public string customProperties_name = "";
    
    public string customProperties_value = "";
    ...
    public string systemProperties__ = "";
    
    public string systemProperties_name = "";
    
    public string systemProperties_value = "";
    
    public string wildValue = "";
    
    public string wildValue2 = "";
    ...
    private string uriBuilderPath {
        get {
            return string.Format("/device/devices/{0}/devicedatasources/{1}/instances/{2}",deviceId,hdsId,id_p);
        }
    }
    
    private string postData {
        get {
            return string.Format("{{ \"autoProperties\": [    {{     \"name\": \"{0}\",      \"value\": \"{1}\"     }}  ],  \"customProperties\": [    {{     \"name\": \"{2}\",      \"value\": \"{3}\"     }}  ],  \"description\": \"{4}\",  \"disableAlerting\": \"{5}\",  \"displayName\": \"{6}\",  \"groupId\": \"{7}\",  \"lockDescription\": \"{8}\",  \"stopMonitoring\": \"{9}\",  \"systemProperties\": [    {{     \"name\": \"{10}\",      \"value\": \"{11}\"     }}  ],  \"wildValue\": \"{12}\",  \"wildValue2\": \"{13}\" }}",name_p,value,customProperties_name,customProperties_value,description,disableAlerting,displayName,groupId,lockDescription,stopMonitoring,systemProperties_name,systemProperties_value,wildValue,wildValue2);
        }
    }
