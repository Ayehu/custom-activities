...
{
    public class LM_get_device_datasource_instance_group : IActivityAsync
    {
...
_queryStringArray = new Dictionary<string, string>() { {"fields",fields} };
            }
return _queryStringArray;
    ...
    public LM_get_device_datasource_instance_group() {
    }
    
    public LM_get_device_datasource_instance_group(string endPoint, string Jsonkeypath, string accessid, string password1, string deviceId, string deviceDsId, string id_p, string fields) {
