...
{
    public class LM_collect_a_config_for_a_device : IActivityAsync
    {
    ...
    public string Jsonkeypath = "collectNow";
...
_uriBuilderPath = string.Format("/device/devices/{0}/devicedatasources/{1}/instances/{2}/config/collectNow",deviceId,hdsId,instanceId);
            }
...
return _queryStringArray;
    ...
    public LM_collect_a_config_for_a_device() {
    }
    
    public LM_collect_a_config_for_a_device(string endPoint, string Jsonkeypath, string accessid, string password1, string deviceId, string hdsId, string instanceId) {
