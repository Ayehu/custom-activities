...
{
    public class CustomActivity_LM_collect_a_config_for_a_device : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("/device/devices/{0}/devicedatasources/{1}/instances/{2}/config/collectNow",deviceId,hdsId,instanceId);
        }
    }
