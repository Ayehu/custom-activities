...
{
    public class CustomActivity_LM_update_device_datasource_instance_groupA : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("/device/devices/{0}/devicedatasources/{1}/groups/{2}",deviceId,deviceDsId,id_p);
        }
    }
