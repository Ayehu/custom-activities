...
{
    public class LM_update_device_instance : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/device/devices/{0}/devicedatasources/{1}/instances/{2}",deviceId,hdsId,id_p);
            }
...
_postData = string.Format("{{ \"autoProperties\": {0},  \"customProperties\": {1},  \"description\": \"{2}\",  \"disableAlerting\": \"{3}\",  \"displayName\": \"{4}\",  \"groupId\": \"{5}\",  \"lockDescription\": \"{6}\",  \"stopMonitoring\": \"{7}\",  \"systemProperties\": {8},  \"wildValue\": \"{9}\",  \"wildValue2\": \"{10}\" }}",autoProperties,customProperties,description_p,disableAlerting,displayName_p,groupId,lockDescription,stopMonitoring,systemProperties,wildValue,wildValue2);
            }
return _postData;
        }
        set {
...
return _queryStringArray;
    ...
    public LM_update_device_instance() {
    }
