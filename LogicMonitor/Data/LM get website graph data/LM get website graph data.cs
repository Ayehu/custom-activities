...
{
    public class CustomActivity_LM_get_website_graph_data : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("/service/services/{serviceId}/checkpoints/{0}/graphs/{1}/data",checkpointId,graphName);
        }
    }
    ...
    private System.Collections.Generic.Dictionary<string, string> queryStringArray {
        get {
            return new Dictionary<string, string>() {{"websiteId",websiteId},{"start",start},{"end",end},{"format",format}};
        }
    }
