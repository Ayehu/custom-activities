...
{
    public class LM_get_website_graph_data : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/website/websites/{0}/checkpoints/{1}/graphs/{2}/data",websiteId,checkpointId,graphName);
            }
...
return _queryStringArray;
    ...
    public LM_get_website_graph_data() {
    }
    
    public LM_get_website_graph_data(string endPoint, string Jsonkeypath, string accessid, string password1, string websiteId, string checkpointId, string start, string end, string graphName, string format) {
