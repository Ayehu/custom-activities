...
{
    public class LM_fetch_device_instances_data : IActivityAsync
    {
    ...
    public string Jsonkeypath = "datafetch";
...
_uriBuilderPath = "/device/instances/datafetch";
            }
...
_postData = string.Format("{{ \"instanceIds\": \"{0}\" }}",instanceIds);
            }
return _postData;
        }
        set {
...
return _queryStringArray;
    ...
    public LM_fetch_device_instances_data() {
    }
    
    public LM_fetch_device_instances_data(string endPoint, string Jsonkeypath, string accessid, string password1, string instanceIds) {
