...
{
    public class CustomActivity_LM_fetch_device_instances_data : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return "/device/instances/datafetch";
        }
    }
    
    private string postData {
        get {
            return string.Format("{{ \"instanceIds\": \"{0}\" }}",instanceIds);
        }
    }
