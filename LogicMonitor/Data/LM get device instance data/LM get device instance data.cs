...
{
    public class CustomActivity_LM_get_device_instance_data : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("/device/devicedatasourceinstances/{0}/graphs/{1}/data",instanceId,graphId);
        }
    }
