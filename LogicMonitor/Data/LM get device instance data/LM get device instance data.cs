...
{
    public class LM_get_device_instance_data : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/device/devices/{0}/devicedatasources/{1}/instances/{2}/data",deviceId,hdsId,id_p);
            }
...
_queryStringArray = new Dictionary<string, string>() { {"period",period},{"start",start},{"end",end},{"datapoints",datapoints},{"format",format} };
            }
return _queryStringArray;
    ...
    public LM_get_device_instance_data() {
    }
    
    public LM_get_device_instance_data(string endPoint, string Jsonkeypath, string accessid, string password1, string deviceId, string hdsId, string id_p, string period, string start, string end, string datapoints, string format) {
