...
{
    public class CustomActivity_LM_get_device_instance_dataA : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("/device/devices/{0}/devicedatasources/{1}/instances/{2}/data",deviceId,hdsId,id_p);
        }
    }
    ...
    private System.Collections.Generic.Dictionary<string, string> queryStringArray {
        get {
            return new Dictionary<string, string>() {{"period",period},{"start",start},{"end",end},{"datapoints",datapoints},{"format",format}};
        }
    }
