...
{
    public class LM_get_device_instance_group_overview_graph_data : IActivityAsync
    {
    ...
    public string Jsonkeypath = "data";
    ...
    public string deviceDsId = "";
    
    public string dsigId = "";
    
    public string start = "";
    
    public string end = "";
    
    public string ographId = "";
...
_uriBuilderPath = string.Format("/device/devices/{0}/devicedatasources/{1}/groups/{2}/graphs/{3}/data",deviceId,deviceDsId,dsigId,ographId);
            }
...
_queryStringArray = new Dictionary<string, string>() { {"start",start},{"end",end},{"format",format} };
            }
return _queryStringArray;
    ...
    public LM_get_device_instance_group_overview_graph_data() {
    }
    
    public LM_get_device_instance_group_overview_graph_data(string endPoint, string Jsonkeypath, string accessid, string password1, string deviceId, string deviceDsId, string dsigId, string start, string end, string ographId, string format) {
        this.endPoint = endPoint;
        this.Jsonkeypath = Jsonkeypath;
        this.accessid = accessid;
        this.password1 = password1;
        this.deviceId = deviceId;
        this.deviceDsId = deviceDsId;
        this.dsigId = dsigId;
        this.start = start;
        this.end = end;
        this.ographId = ographId;
        this.format = format;
    }
