...
{
    public class CustomActivity_LM_get_device_instance_group_overview_graph_data : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("/device/devices/{0}/devicedatasources/{1}/groups/{2}/graphs/{3}/data",deviceId,deviceDsId,dsigId,ographId);
        }
    }
    ...
    private System.Collections.Generic.Dictionary<string, string> queryStringArray {
        get {
            return new Dictionary<string, string>() {{"start",start},{"end",end},{"format",format}};
        }
    }
