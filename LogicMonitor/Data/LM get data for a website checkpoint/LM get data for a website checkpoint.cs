...
{
    public class CustomActivity_LM_get_data_for_a_website_checkpoint : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("/service/services/{0}/checkpoints/{1}/data",srvId,checkId);
        }
    }
    ...
    private System.Collections.Generic.Dictionary<string, string> queryStringArray {
        get {
            return new Dictionary<string, string>() {{"period",period},{"start",start},{"end",end},{"datapoints",datapoints},{"format",format},{"aggregate",aggregate}};
        }
    }
