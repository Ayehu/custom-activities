...
{
    public class LM_get_data_for_a_website_checkpoint : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/website/websites/{0}/checkpoints/{1}/data",srvId,checkId);
            }
...
_queryStringArray = new Dictionary<string, string>() { {"period",period},{"start",start},{"end",end},{"datapoints",datapoints},{"format",format},{"aggregate",aggregate} };
            }
return _queryStringArray;
    ...
    public LM_get_data_for_a_website_checkpoint() {
    }
    
    public LM_get_data_for_a_website_checkpoint(string endPoint, string Jsonkeypath, string accessid, string password1, string srvId, string checkId, string period, string start, string end, string datapoints, string format, string aggregate) {
