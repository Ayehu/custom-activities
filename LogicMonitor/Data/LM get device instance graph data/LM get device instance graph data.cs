...
{
    public class LM_get_device_instance_graph_data : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/device/devices/{0}/devicedatasources/{1}/instances/{2}/graphs/{3}/data",deviceId,hdsId,id_p,graphId);
            }
...
return _queryStringArray;
    ...
    public LM_get_device_instance_graph_data() {
    }
    
    public LM_get_device_instance_graph_data(string endPoint, string Jsonkeypath, string accessid, string password1, string deviceId, string hdsId, string id_p, string start, string end, string graphId, string format) {
