...
{
    public class CustomActivity_LM_get_device_instance_graph_data : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("/device/devices/{0}/devicedatasources/{1}/instances/{2}/graphs/{3}/data",deviceId,hdsId,id_p,graphId);
        }
    }
