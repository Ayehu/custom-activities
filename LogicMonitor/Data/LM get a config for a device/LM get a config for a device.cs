...
{
    public class CustomActivity_LM_get_a_config_for_a_device : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("/device/devices/{0}/devicedatasources/{1}/instances/{2}/config/{3}",deviceId,hdsId,instanceId,id_p);
        }
    }
    ...
    private System.Collections.Generic.Dictionary<string, string> queryStringArray {
        get {
            return new Dictionary<string, string>() {{"format",format},{"startEpoch",startEpoch},{"fields",fields}};
        }
    }
