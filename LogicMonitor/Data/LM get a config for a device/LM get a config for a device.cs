...
{
    public class LM_get_a_config_for_a_device : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/device/devices/{0}/devicedatasources/{1}/instances/{2}/config/{3}",deviceId,hdsId,instanceId,id_p);
            }
...
_queryStringArray = new Dictionary<string, string>() { {"format",format},{"startEpoch",startEpoch},{"fields",fields} };
            }
return _queryStringArray;
    ...
    public LM_get_a_config_for_a_device() {
    }
    
    public LM_get_a_config_for_a_device(string endPoint, string Jsonkeypath, string accessid, string password1, string deviceId, string hdsId, string instanceId, string id_p, string format, string startEpoch, string fields) {
