...
{
    public class LM_run_a_report : IActivityAsync
    {
    ...
    public string Jsonkeypath = "executions";
...
_uriBuilderPath = string.Format("/report/reports/{0}/executions",id_p);
            }
...
_postData = string.Format("{{ \"receiveEmails\": \"{0}\",  \"reportId\": \"{1}\" }}",receiveEmails,reportId);
            }
return _postData;
        }
        set {
...
return _queryStringArray;
    ...
    public LM_run_a_report() {
    }
    
    public LM_run_a_report(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p, string receiveEmails, string reportId) {
