...
{
    public class CustomActivity_LM_run_a_report : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("/report/reports/{0}/executions",id_p);
        }
    }
    
    private string postData {
        get {
            return string.Format("{{ \"receiveEmails\": \"{0}\",  \"reportId\": \"{1}\" }}",receiveEmails,reportId);
        }
    }
