...
{
    public class LM_delete_report : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_delete_report() {
    }
    
    public LM_delete_report(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p) {
