...
{
    public class LM_add_report : IActivityAsync
    {
...
_uriBuilderPath = "/report/reports";
            }
...
return _queryStringArray;
    ...
    public LM_add_report() {
    }
    
    public LM_add_report(string endPoint, string Jsonkeypath, string accessid, string password1, string delivery, string description_p, string format, string groupId, string name_p, string recipients, string schedule, string scheduleTimezone, string _type) {
