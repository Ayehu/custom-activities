...
{
    public class LM_get_report_by_id : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_get_report_by_id() {
    }
    
    public LM_get_report_by_id(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p, string fields) {
