...
{
    public class CustomActivity_LM_update_device_group_datasource_alert_settingA : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("/device/groups/{0}/datasources/{1}/alertsettings",deviceGroupId,dsId);
        }
    }
