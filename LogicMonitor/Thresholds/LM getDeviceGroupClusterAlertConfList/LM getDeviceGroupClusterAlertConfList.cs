...
{
    public class LM_getDeviceGroupClusterAlertConfList : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_getDeviceGroupClusterAlertConfList() {
    }
    
    public LM_getDeviceGroupClusterAlertConfList(string endPoint, string Jsonkeypath, string accessid, string password1, string deviceGroupId, string fields, string size, string offset, string filter) {
