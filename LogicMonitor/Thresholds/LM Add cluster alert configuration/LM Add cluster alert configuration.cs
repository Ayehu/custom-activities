...
{
    public class LM_Add_cluster_alert_configuration : IActivityAsync
    {
    ...
    public string Jsonkeypath = "clusterAlertConf";
    ...
    public string minAlertLevel = "";
    
    public string suppressIndAlert = "";
...
_uriBuilderPath = string.Format("/device/groups/{0}/clusterAlertConf",deviceGroupId);
            }
...
return _queryStringArray;
    ...
    public LM_Add_cluster_alert_configuration() {
    }
    
    public LM_Add_cluster_alert_configuration(string endPoint, string Jsonkeypath, string accessid, string password1, string deviceGroupId, string alertExpr, string countBy, string dataSourceDisplayName, string dataSourceId, string disableAlerting, string minAlertLevel, string suppressIndAlert, string thresholdType) {
