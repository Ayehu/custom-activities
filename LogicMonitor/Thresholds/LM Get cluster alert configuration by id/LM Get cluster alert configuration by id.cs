...
{
    public class LM_Get_cluster_alert_configuration_by_id : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_Get_cluster_alert_configuration_by_id() {
    }
    
    public LM_Get_cluster_alert_configuration_by_id(string endPoint, string Jsonkeypath, string accessid, string password1, string deviceGroupId, string id_p) {
