...
{
    public class LM_Delete_cluster_alert_configuration : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_Delete_cluster_alert_configuration() {
    }
    
    public LM_Delete_cluster_alert_configuration(string endPoint, string Jsonkeypath, string accessid, string password1, string deviceGroupId, string id_p) {
