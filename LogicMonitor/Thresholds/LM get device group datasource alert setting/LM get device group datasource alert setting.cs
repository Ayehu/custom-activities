...
{
    public class LM_get_device_group_datasource_alert_setting : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/device/groups/{0}/datasources/{1}/alertsettings",deviceGroupId,dsId);
            }
...
return _queryStringArray;
    ...
    public LM_get_device_group_datasource_alert_setting() {
    }
    
    public LM_get_device_group_datasource_alert_setting(string endPoint, string Jsonkeypath, string accessid, string password1, string deviceGroupId, string dsId, string fields) {
