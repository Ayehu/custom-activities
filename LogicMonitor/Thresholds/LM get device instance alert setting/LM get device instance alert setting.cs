...
{
    public class LM_get_device_instance_alert_setting : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_get_device_instance_alert_setting() {
    }
    
    public LM_get_device_instance_alert_setting(string endPoint, string Jsonkeypath, string accessid, string password1, string deviceId, string hdsId, string instanceId, string id_p, string fields) {
