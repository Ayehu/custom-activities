...
{
    public class CustomActivity_LM_getDeviceDatasourceInstanceAlertSettingListOfDSI : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("/device/devices/{0}/devicedatasources/{1}/instances/{2}/alertsettings",deviceId,hdsId,instanceId);
        }
    }
    ...
    private System.Collections.Generic.Dictionary<string, string> queryStringArray {
        get {
            return new Dictionary<string, string>() {{"size",size},{"offset",offset}};
        }
    }
