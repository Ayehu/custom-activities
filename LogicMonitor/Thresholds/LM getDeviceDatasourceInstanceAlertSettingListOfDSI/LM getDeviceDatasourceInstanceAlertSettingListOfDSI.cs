...
{
    public class LM_getDeviceDatasourceInstanceAlertSettingListOfDSI : IActivityAsync
    {
    ...
    public string Jsonkeypath = "alertsettings";
...
_uriBuilderPath = string.Format("/device/devices/{0}/devicedatasources/{1}/instances/{2}/alertsettings",deviceId,hdsId,instanceId);
            }
...
_queryStringArray = new Dictionary<string, string>() { {"size",size},{"offset",offset} };
            }
return _queryStringArray;
    ...
    public LM_getDeviceDatasourceInstanceAlertSettingListOfDSI() {
    }
    
    public LM_getDeviceDatasourceInstanceAlertSettingListOfDSI(string endPoint, string Jsonkeypath, string accessid, string password1, string deviceId, string hdsId, string instanceId, string size, string offset) {
