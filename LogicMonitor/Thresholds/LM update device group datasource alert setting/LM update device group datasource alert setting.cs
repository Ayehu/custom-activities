...
{
    public class LM_update_device_group_datasource_alert_setting : IActivityAsync
    {
...
_postData = string.Format("\"{0}\"",body);
            }
return _postData;
        }
        set {
...
return _queryStringArray;
    ...
    public LM_update_device_group_datasource_alert_setting() {
    }
    
    public LM_update_device_group_datasource_alert_setting(string endPoint, string Jsonkeypath, string accessid, string password1, string deviceGroupId, string dsId, string body) {
