...
{
    public class LM_update_recipient_group : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/setting/recipientgroups/{0}",id_p);
            }
...
_postData = string.Format("{{ \"description\": \"{0}\",  \"groupName\": \"{1}\",  \"recipients\": {2} }}",description_p,groupName,recipients);
            }
return _postData;
        }
        set {
...
return _queryStringArray;
    ...
    public LM_update_recipient_group() {
    }
    
    public LM_update_recipient_group(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p, string description_p, string groupName, string recipients) {
