...
{
    public class LM_get_recipient_group_List : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_get_recipient_group_List() {
    }
    
    public LM_get_recipient_group_List(string endPoint, string Jsonkeypath, string accessid, string password1, string fields, string size, string offset, string filter) {
