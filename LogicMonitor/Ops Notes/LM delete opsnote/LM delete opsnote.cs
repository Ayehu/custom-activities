...
{
    public class LM_delete_opsnote : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_delete_opsnote() {
    }
    
    public LM_delete_opsnote(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p) {
