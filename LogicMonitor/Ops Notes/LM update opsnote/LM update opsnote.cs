...
{
    public class LM_update_opsnote : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/setting/opsnotes/{0}",id_p);
            }
...
return _queryStringArray;
    ...
    public LM_update_opsnote() {
    }
    
    public LM_update_opsnote(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p, string happenOnInSec, string note, string scopes, string tags) {
