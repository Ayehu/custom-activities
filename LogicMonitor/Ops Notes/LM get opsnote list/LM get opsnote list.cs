...
{
    public class LM_get_opsnote_list : IActivityAsync
    {
    ...
    public string Jsonkeypath = "opsnotes";
...
return _queryStringArray;
    ...
    public LM_get_opsnote_list() {
    }
    
    public LM_get_opsnote_list(string endPoint, string Jsonkeypath, string accessid, string password1, string fields, string size, string offset, string filter) {
