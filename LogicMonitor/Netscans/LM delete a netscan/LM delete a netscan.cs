...
{
    public class LM_delete_a_netscan : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_delete_a_netscan() {
    }
    
    public LM_delete_a_netscan(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p) {
