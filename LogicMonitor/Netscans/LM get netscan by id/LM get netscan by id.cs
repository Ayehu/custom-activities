...
{
    public class LM_get_netscan_by_id : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/setting/netscans/{0}",id_p);
            }
...
return _queryStringArray;
    ...
    public LM_get_netscan_by_id() {
    }
    
    public LM_get_netscan_by_id(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p) {
