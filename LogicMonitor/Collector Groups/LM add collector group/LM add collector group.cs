...
{
    public class LM_add_collector_group : IActivityAsync
    {
...
_uriBuilderPath = "/setting/collector/groups";
            }
...
return _queryStringArray;
    ...
    public LM_add_collector_group() {
    }
    
    public LM_add_collector_group(string endPoint, string Jsonkeypath, string accessid, string password1, string customProperties, string description_p, string _name) {
