...
{
    public class LM_get_collector_group : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_get_collector_group() {
    }
    
    public LM_get_collector_group(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p, string fields) {
