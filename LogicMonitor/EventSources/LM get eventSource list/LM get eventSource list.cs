...
{
    public class LM_get_eventSource_list : IActivityAsync
    {
    ...
    public string Jsonkeypath = "eventsources";
...
_uriBuilderPath = "/setting/eventsources";
            }
...
_queryStringArray = new Dictionary<string, string>() { {"format",format},{"fields",fields},{"size",size},{"offset",offset},{"filter",filter} };
            }
return _queryStringArray;
    ...
    public LM_get_eventSource_list() {
    }
    
    public LM_get_eventSource_list(string endPoint, string Jsonkeypath, string accessid, string password1, string format, string fields, string size, string offset, string filter) {
