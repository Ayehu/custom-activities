...
{
    public class CustomActivity_LM_get_eventSource_list : IActivityAsync
    {
    ...
    private System.Collections.Generic.Dictionary<string, string> queryStringArray {
        get {
            return new Dictionary<string, string>() {{"format",format},{"fields",fields},{"size",size},{"offset",offset},{"filter",filter}};
        }
    }
