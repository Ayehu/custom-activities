...
{
    public class LM_get_alert_rule_list : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_get_alert_rule_list() {
    }
    
    public LM_get_alert_rule_list(string endPoint, string Jsonkeypath, string accessid, string password1, string fields, string size, string offset, string filter) {
