...
{
    public class LM_update_alert_rule : IActivityAsync
    {
    ...
    public string escalationInterval = "";
    ...
    public string suppressAlertAckSdt = "";
...
_uriBuilderPath = string.Format("/setting/alert/rules/{0}",id_p);
            }
...
return _queryStringArray;
    ...
    public LM_update_alert_rule() {
    }
    
    public LM_update_alert_rule(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p, string datapoint, string datasource, string escalatingChainId, string escalationInterval, string instance, string levelStr, string name_p, string priority, string suppressAlertAckSdt, string suppressAlertClear) {
