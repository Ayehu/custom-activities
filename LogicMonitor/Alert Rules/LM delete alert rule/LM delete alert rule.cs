...
{
    public class LM_delete_alert_rule : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_delete_alert_rule() {
    }
    
    public LM_delete_alert_rule(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p) {
