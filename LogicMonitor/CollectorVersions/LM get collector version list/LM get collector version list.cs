...
{
    public class LM_get_collector_version_list : IActivityAsync
    {
    ...
    public string Jsonkeypath = "versions";
...
_uriBuilderPath = "/setting/collector/collectors/versions";
            }
...
return _queryStringArray;
    ...
    public LM_get_collector_version_list() {
    }
    
    public LM_get_collector_version_list(string endPoint, string Jsonkeypath, string accessid, string password1, string fields, string size, string offset, string filter) {
