...
{
    public class LM_delete_SDT : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_delete_SDT() {
    }
    
    public LM_delete_SDT(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p) {
