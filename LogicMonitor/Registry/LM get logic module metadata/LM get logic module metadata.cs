...
{
    public class LM_get_logic_module_metadata : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/setting/registry/metadata/{0}/{1}",lmType,lmId);
            }
...
return _queryStringArray;
    ...
    public LM_get_logic_module_metadata() {
    }
    
    public LM_get_logic_module_metadata(string endPoint, string Jsonkeypath, string accessid, string password1, string lmType, string lmId) {
