...
{
    public class LM_delete_a_device : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_delete_a_device() {
    }
    
    public LM_delete_a_device(string endPoint, string Jsonkeypath, string accessid, string password1, string start, string end, string netflowFilter, string id_p, string deleteHard) {
