...
{
    public class LM_get_a_list_of_alert_settings_for_a_device : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/device/devices/{0}/alertsettings",deviceId);
            }
...
_queryStringArray = new Dictionary<string, string>() { {"start",start},{"end",end},{"netflowFilter",netflowFilter},{"size",size},{"offset",offset} };
            }
return _queryStringArray;
    ...
    public LM_get_a_list_of_alert_settings_for_a_device() {
    }
    
    public LM_get_a_list_of_alert_settings_for_a_device(string endPoint, string Jsonkeypath, string accessid, string password1, string start, string end, string netflowFilter, string deviceId, string size, string offset) {
