...
{
    public class CustomActivity_LM_get_a_list_of_alert_settings_for_a_device : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("/device/devices/{0}/alertsettings",deviceId);
        }
    }
    ...
    private System.Collections.Generic.Dictionary<string, string> queryStringArray {
        get {
            return new Dictionary<string, string>() {{"start",start},{"end",end},{"netflowFilter",netflowFilter},{"size",size},{"offset",offset}};
        }
    }
