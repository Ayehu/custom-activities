...
{
    public class LM_get_device_datasource : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/device/devices/{0}/devicedatasources/{1}",deviceId,id_p);
            }
...
return _queryStringArray;
    ...
    public LM_get_device_datasource() {
    }
    
    public LM_get_device_datasource(string endPoint, string Jsonkeypath, string accessid, string password1, string deviceId, string id_p, string fields) {
