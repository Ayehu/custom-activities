...
{
    public class LM_get_device_datasource_list : IActivityAsync
    {
    ...
    public string Jsonkeypath = "devicedatasources";
...
_uriBuilderPath = string.Format("/device/devices/{0}/devicedatasources",deviceId);
            }
...
return _queryStringArray;
    ...
    public LM_get_device_datasource_list() {
    }
    
    public LM_get_device_datasource_list(string endPoint, string Jsonkeypath, string accessid, string password1, string deviceId, string fields, string size, string offset, string filter) {
