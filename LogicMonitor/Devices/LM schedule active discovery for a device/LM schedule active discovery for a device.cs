...
{
    public class LM_schedule_active_discovery_for_a_device : IActivityAsync
    {
    ...
    public string Jsonkeypath = "scheduleAutoDiscovery";
...
_uriBuilderPath = string.Format("/device/devices/{0}/scheduleAutoDiscovery",id_p);
            }
...
_queryStringArray = new Dictionary<string, string>() { {"start",start},{"end",end},{"netflowFilter",netflowFilter} };
            }
return _queryStringArray;
    ...
    public LM_schedule_active_discovery_for_a_device() {
    }
    
    public LM_schedule_active_discovery_for_a_device(string endPoint, string Jsonkeypath, string accessid, string password1, string start, string end, string netflowFilter, string id_p) {
