...
{
    public class LM_get_device_list : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_get_device_list() {
    }
    
    public LM_get_device_list(string endPoint, string Jsonkeypath, string accessid, string password1, string start, string end, string netflowFilter, string fields, string size, string offset, string filter) {
