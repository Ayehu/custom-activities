...
{
    public class LM_update_device_property : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_update_device_property() {
    }
    
    public LM_update_device_property(string endPoint, string Jsonkeypath, string accessid, string password1, string deviceId, string name_p, string body) {
