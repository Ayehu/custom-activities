...
{
    public class LM_get_device_datasource_data : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/device/devices/{0}/devicedatasources/{1}/data",deviceId,id_p);
            }
...
return _queryStringArray;
    ...
    public LM_get_device_datasource_data() {
    }
    
    public LM_get_device_datasource_data(string endPoint, string Jsonkeypath, string accessid, string password1, string deviceId, string id_p, string period, string start, string end, string datapoints, string format, string aggregate) {
