...
{
    public class LM_get_device_property_by_name : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/device/devices/{0}/properties/{1}",deviceId,name_p);
            }
...
return _queryStringArray;
    ...
    public LM_get_device_property_by_name() {
    }
    
    public LM_get_device_property_by_name(string endPoint, string Jsonkeypath, string accessid, string password1, string deviceId, string name_p, string fields) {
