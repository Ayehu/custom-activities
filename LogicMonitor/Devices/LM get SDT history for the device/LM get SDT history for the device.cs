...
{
    public class LM_get_SDT_history_for_the_device : IActivityAsync
    {
    ...
    public string Jsonkeypath = "historysdts";
...
_uriBuilderPath = string.Format("/device/devices/{0}/historysdts",id_p);
            }
...
_queryStringArray = new Dictionary<string, string>() { {"start",start},{"end",end},{"netflowFilter",netflowFilter},{"fields",fields},{"size",size},{"offset",offset},{"filter",filter} };
            }
return _queryStringArray;
    ...
    public LM_get_SDT_history_for_the_device() {
    }
    
    public LM_get_SDT_history_for_the_device(string endPoint, string Jsonkeypath, string accessid, string password1, string start, string end, string netflowFilter, string id_p, string fields, string size, string offset, string filter) {
