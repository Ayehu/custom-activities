...
{
    public class CustomActivity_LM_get_SDT_history_for_the_device : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("/device/devices/{0}/historysdts",id_p);
        }
    }
    ...
    private System.Collections.Generic.Dictionary<string, string> queryStringArray {
        get {
            return new Dictionary<string, string>() {{"start",start},{"end",end},{"netflowFilter",netflowFilter},{"fields",fields},{"size",size},{"offset",offset},{"filter",filter}};
        }
    }
