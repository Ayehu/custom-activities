...
{
    public class LM_delete_device_property : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_delete_device_property() {
    }
    
    public LM_delete_device_property(string endPoint, string Jsonkeypath, string accessid, string password1, string deviceId, string name_p) {
