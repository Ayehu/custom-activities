...
{
    public class CustomActivity_LM_get_SDT_history_for_the_device_dataSource : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("/device/devices/{0}/devicedatasources/{1}/historysdts",deviceId,id_p);
        }
    }
