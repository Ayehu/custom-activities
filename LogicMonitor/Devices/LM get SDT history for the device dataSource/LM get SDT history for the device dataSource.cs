...
{
    public class LM_get_SDT_history_for_the_device_dataSource : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/device/devices/{0}/devicedatasources/{1}/historysdts",deviceId,id_p);
            }
...
return _queryStringArray;
    ...
    public LM_get_SDT_history_for_the_device_dataSource() {
    }
    
    public LM_get_SDT_history_for_the_device_dataSource(string endPoint, string Jsonkeypath, string accessid, string password1, string deviceId, string id_p, string fields, string size, string offset, string filter) {
