...
{
    public class LM_get_netflow_flow_list : IActivityAsync
    {
    ...
    public string Jsonkeypath = "flows";
...
_uriBuilderPath = string.Format("/device/devices/{0}/flows",id_p);
            }
...
return _queryStringArray;
    ...
    public LM_get_netflow_flow_list() {
    }
    
    public LM_get_netflow_flow_list(string endPoint, string Jsonkeypath, string accessid, string password1, string start, string end, string netflowFilter, string id_p, string fields, string size, string offset, string filter) {
