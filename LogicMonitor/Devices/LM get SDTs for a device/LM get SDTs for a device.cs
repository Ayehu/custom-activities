...
{
    public class LM_get_SDTs_for_a_device : IActivityAsync
    {
    ...
    public string Jsonkeypath = "sdts";
...
_uriBuilderPath = string.Format("/device/devices/{0}/sdts",id_p);
            }
...
return _queryStringArray;
    ...
    public LM_get_SDTs_for_a_device() {
    }
    
    public LM_get_SDTs_for_a_device(string endPoint, string Jsonkeypath, string accessid, string password1, string start, string end, string netflowFilter, string id_p, string fields, string size, string offset, string filter) {
