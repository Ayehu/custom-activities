...
{
    public class CustomActivity_LM_get_top_talkers_graph : IActivityAsync
    {
    ...
    public string Jsonkeypath = "topTalkersGraph";
    ...
    private string uriBuilderPath {
        get {
            return string.Format("/device/devices/{0}/topTalkersGraph",id_p);
        }
    }
    ...
    private System.Collections.Generic.Dictionary<string, string> queryStringArray {
        get {
            return new Dictionary<string, string>() {{"start",start},{"end",end},{"netflowFilter",netflowFilter},{"format",format},{"keyword",keyword}};
        }
    }
