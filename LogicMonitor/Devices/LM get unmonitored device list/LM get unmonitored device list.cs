...
{
    public class LM_get_unmonitored_device_list : IActivityAsync
    {
    ...
    public string Jsonkeypath = "unmonitoreddevices";
...
_uriBuilderPath = "/device/unmonitoreddevices";
            }
...
return _queryStringArray;
    ...
    public LM_get_unmonitored_device_list() {
    }
    
    public LM_get_unmonitored_device_list(string endPoint, string Jsonkeypath, string accessid, string password1, string fields, string size, string offset, string filter) {
