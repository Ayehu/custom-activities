...
{
    public class LM_get_device_by_id : IActivityAsync
    {
...
_queryStringArray = new Dictionary<string, string>() { {"start",start},{"end",end},{"netflowFilter",netflowFilter},{"fields",fields} };
            }
return _queryStringArray;
    ...
    public LM_get_device_by_id() {
    }
    
    public LM_get_device_by_id(string endPoint, string Jsonkeypath, string accessid, string password1, string start, string end, string netflowFilter, string id_p, string fields) {
