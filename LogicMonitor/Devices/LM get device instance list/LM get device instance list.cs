...
_uriBuilderPath = string.Format("/device/devices/{0}/instances",id_p);
            }
...
return _queryStringArray;
    ...
    public LM_get_device_instance_list(string endPoint, string Jsonkeypath, string accessid, string password1, string start, string end, string netflowFilter, string id_p, string fields, string size, string offset, string filter) {
