...
{
    public class CustomActivity_LM_get_netflow_endpoint_list : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("/device/devices/{0}/endpoints",id_p);
        }
    }
    ...
    private System.Collections.Generic.Dictionary<string, string> queryStringArray {
        get {
            return new Dictionary<string, string>() {{"start",start},{"end",end},{"netflowFilter",netflowFilter},{"port",port},{"fields",fields},{"size",size},{"offset",offset},{"filter",filter}};
        }
    }
