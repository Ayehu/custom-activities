...
{
    public class LM_get_netflow_endpoint_list : IActivityAsync
    {
    ...
    public string Jsonkeypath = "endpoints";
...
_uriBuilderPath = string.Format("/device/devices/{0}/endpoints",id_p);
            }
...
_queryStringArray = new Dictionary<string, string>() { {"start",start},{"end",end},{"netflowFilter",netflowFilter},{"port",port},{"fields",fields},{"size",size},{"offset",offset},{"filter",filter} };
            }
return _queryStringArray;
    ...
    public LM_get_netflow_endpoint_list() {
    }
    
    public LM_get_netflow_endpoint_list(string endPoint, string Jsonkeypath, string accessid, string password1, string start, string end, string netflowFilter, string id_p, string port, string fields, string size, string offset, string filter) {
