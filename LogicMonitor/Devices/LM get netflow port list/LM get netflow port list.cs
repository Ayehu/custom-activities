...
{
    public class CustomActivity_LM_get_netflow_port_list : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("/device/devices/{0}/ports",id_p);
        }
    }
    ...
    private System.Collections.Generic.Dictionary<string, string> queryStringArray {
        get {
            return new Dictionary<string, string>() {{"start",start},{"end",end},{"netflowFilter",netflowFilter},{"ip",ip},{"fields",fields},{"size",size},{"offset",offset},{"filter",filter}};
        }
    }
