...
{
    public class LM_get_netflow_port_list : IActivityAsync
    {
    ...
    public string Jsonkeypath = "ports";
...
_uriBuilderPath = string.Format("/device/devices/{0}/ports",id_p);
            }
...
_queryStringArray = new Dictionary<string, string>() { {"start",start},{"end",end},{"netflowFilter",netflowFilter},{"ip",ip},{"fields",fields},{"size",size},{"offset",offset},{"filter",filter} };
            }
return _queryStringArray;
    ...
    public LM_get_netflow_port_list() {
    }
    
    public LM_get_netflow_port_list(string endPoint, string Jsonkeypath, string accessid, string password1, string start, string end, string netflowFilter, string id_p, string ip, string fields, string size, string offset, string filter) {
