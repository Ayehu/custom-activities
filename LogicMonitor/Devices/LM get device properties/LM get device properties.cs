...
{
    public class LM_get_device_properties : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/device/devices/{0}/properties",deviceId);
            }
...
return _queryStringArray;
    ...
    public LM_get_device_properties() {
    }
    
    public LM_get_device_properties(string endPoint, string Jsonkeypath, string accessid, string password1, string deviceId, string fields, string size, string offset, string filter) {
