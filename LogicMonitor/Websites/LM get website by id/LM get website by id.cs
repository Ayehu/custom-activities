...
{
    public class LM_get_website_by_id : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/website/websites/{0}",id_p);
            }
...
_queryStringArray = new Dictionary<string, string>() { {"format",format} };
            }
return _queryStringArray;
    ...
    public LM_get_website_by_id() {
    }
    
    public LM_get_website_by_id(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p, string format) {
