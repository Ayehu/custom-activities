...
{
    public class CustomActivity_LM_get_website_list : IActivityAsync
    {
    ...
    private System.Collections.Generic.Dictionary<string, string> queryStringArray {
        get {
            return new Dictionary<string, string>() {{"collectorIds",collectorIds},{"fields",fields},{"size",size},{"offset",offset},{"filter",filter}};
        }
    }
