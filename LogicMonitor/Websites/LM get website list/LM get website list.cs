...
{
    public class LM_get_website_list : IActivityAsync
    {
...
_queryStringArray = new Dictionary<string, string>() { {"collectorIds",collectorIds},{"fields",fields},{"size",size},{"offset",offset},{"filter",filter} };
            }
return _queryStringArray;
    ...
    public LM_get_website_list() {
    }
    
    public LM_get_website_list(string endPoint, string Jsonkeypath, string accessid, string password1, string collectorIds, string fields, string size, string offset, string filter) {
