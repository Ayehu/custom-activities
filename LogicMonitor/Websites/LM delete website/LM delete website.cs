...
{
    public class LM_delete_website : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public LM_delete_website() {
    }
    
    public LM_delete_website(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p) {
