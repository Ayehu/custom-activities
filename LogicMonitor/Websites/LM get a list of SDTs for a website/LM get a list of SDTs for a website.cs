...
{
    public class LM_get_a_list_of_SDTs_for_a_website : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/website/websites/{0}/sdts",id_p);
            }
...
return _queryStringArray;
    ...
    public LM_get_a_list_of_SDTs_for_a_website() {
    }
    
    public LM_get_a_list_of_SDTs_for_a_website(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p, string fields, string size, string offset, string filter) {
