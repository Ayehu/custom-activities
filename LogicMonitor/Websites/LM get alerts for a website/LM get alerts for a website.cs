...
{
    public class CustomActivity_LM_get_alerts_for_a_website : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("/service/services/{0}/alerts",id_p);
        }
    }
    ...
    private System.Collections.Generic.Dictionary<string, string> queryStringArray {
        get {
            return new Dictionary<string, string>() {{"needMessage",needMessage},{"customColumns",customColumns},{"fields",fields},{"size",size},{"offset",offset},{"filter",filter}};
        }
    }
