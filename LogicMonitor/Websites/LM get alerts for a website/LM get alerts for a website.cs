...
{
    public class LM_get_alerts_for_a_website : IActivityAsync
    {
    ...
    public string Jsonkeypath = "alerts";
...
_uriBuilderPath = string.Format("/website/websites/{0}/alerts",id_p);
            }
...
_queryStringArray = new Dictionary<string, string>() { {"needMessage",needMessage},{"customColumns",customColumns},{"fields",fields},{"size",size},{"offset",offset},{"filter",filter} };
            }
return _queryStringArray;
    ...
    public LM_get_alerts_for_a_website() {
    }
    
    public LM_get_alerts_for_a_website(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p, string needMessage, string customColumns, string fields, string size, string offset, string filter) {
