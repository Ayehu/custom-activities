...
{
    public class LM_get_website_data_by_graph_name : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/website/websites/{0}/graphs/{1}/data",id_p,graphName);
            }
...
return _queryStringArray;
    ...
    public LM_get_website_data_by_graph_name() {
    }
    
    public LM_get_website_data_by_graph_name(string endPoint, string Jsonkeypath, string accessid, string password1, string id_p, string start, string end, string graphName, string format) {
