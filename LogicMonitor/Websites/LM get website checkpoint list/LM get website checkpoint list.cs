...
{
    public class LM_get_website_checkpoint_list : IActivityAsync
    {
    ...
    public string Jsonkeypath = "smcheckpoints";
...
_uriBuilderPath = "/website/smcheckpoints";
            }
...
return _queryStringArray;
    ...
    public LM_get_website_checkpoint_list() {
    }
    
    public LM_get_website_checkpoint_list(string endPoint, string Jsonkeypath, string accessid, string password1, string fields, string size, string offset, string filter) {
