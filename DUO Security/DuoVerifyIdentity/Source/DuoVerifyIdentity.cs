...
{
    public class DuoVerifyUser : IActivity
    {
        ...
        public ICustomActivityResult Execute()
        {
            ...
            parameters.Add("factor", "auto");
            parameters.Add("username", duoUsername);
            ...
            {       
                return this.GenerateActivityResult(jsonResults["response"]["result"].ToString());
            }
        }
