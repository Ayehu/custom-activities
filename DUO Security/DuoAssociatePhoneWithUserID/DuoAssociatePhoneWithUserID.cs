...
{
	public class DuoAssociatePhoneWithUserID : IActivity
	{
		...
		public ICustomActivityResult Execute()
		{
			...
			var results = new DuoApi(integrationKey, secretKey, apiHost, "https").ApiCall("POST", "/admin/v1/users/" + userID + "/phones", parameters, 0, DateTime.UtcNow, out code);
