...
{
    public class DuoGetPhonesByUserID : IActivity
    {
        public string integrationKey;
        public string secretKey;
        public string apiHost;
        public string duoUserID;
        ...
        public ICustomActivityResult Execute()
        {
            ...
            var results = new DuoApi(integrationKey, secretKey, apiHost, "https").ApiCall("GET", "/admin/v1/users/" + duoUserID + "/phones", parameters, 0, DateTime.UtcNow, out code);
