...
Namespace Ayehu.Sdk.ActivityCreation
    Public Class CustomActivity
        ...
        Function CloseRequest(RequestID As String) As String
            ...
            Using writer As JsonWriter = New JsonTextWriter(sw)
                ...
                writer.WriteStartObject()
                writer.WritePropertyName("Reason")
                writer.WriteValue("Finished with password retrieval")
                writer.WriteEnd()
            ...
            Dim content As System.Net.Http.StringContent = New StringContent(json)
            content.Headers.ContentType = New System.Net.Http.Headers.MediaTypeHeaderValue("application/json")
            Uri.TryCreate(New Uri(BaseUrl), "/BeyondTrust/api/public/v3/Requests/" & RequestID & "/Checkin", url)
            Dim signInResponse As HttpResponseMessage = client.PutAsync(url, content).Result
            If signInResponse.StatusCode <> 200 AndAlso signInResponse.StatusCode <> 204 Then Throw New Exception(signInResponse.ReasonPhrase)
