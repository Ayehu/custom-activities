...
Namespace Ayehu.Sdk.ActivityCreation
	...
	Public DropdownList As String
    Public ColumnLetter As String
    Public StartRow As String
    Public EndRow As String
	...
	Function ReadXLSRemote(ByVal HostName As String, ByVal UserName As String, ByVal Password As String, ByVal Path As String, ExcelEngine As Object, ByVal PreserveTypes As Integer, SheetName As String, SheetTable As String) As DataTable
		...
		Try
			...
			Dim validation1 As IDataValidation = sheet.Range(ColumnLetter + StartRow + ":" + ColumnLetter + EndRow).DataValidation
			Dim DropdownListString = DropdownList.Split(New Char() {","c})
			validation1.ListOfValues = DropdownListString
			...
			dtResult.Rows.Add("Success")
		Catch ex As Exception
			Throw New Exception("Unable to write Excel spreadsheet: " + Err.Description)
		End Try
		End Try
