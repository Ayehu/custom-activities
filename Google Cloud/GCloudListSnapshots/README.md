## GCloudListSnapshots - List snapshots in Google Cloud.

Remark - To list snapshots in Google Cloud you need to set-up a new Service Account at https://cloud.google.com. Check this [tutorial](https://docs.bmc.com/docs/PATROL4GoogleCloudPlatform/10/creating-a-service-account-key-in-the-google-cloud-platform-project-799095477.html).  
...
### Mandatory fields when listing snapshots:
