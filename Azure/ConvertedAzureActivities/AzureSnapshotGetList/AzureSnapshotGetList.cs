...
{
    public class AzureSnapshotGetList : IActivity
    {
        /// <summary>
        ...
        private string uriBuilderPath
        {
            get
            {
                ...
                {
                    _uriBuilderPath = string.Format("/subscriptions/{0}/resourceGroups/{1}/providers/Microsoft.Compute/snapshots", subscriptionId, resourceGroupName);
                }
