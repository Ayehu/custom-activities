...
{
    public class AzureApplicationServiceDelete : IActivity
    {
        ...
        private string uriBuilderPath
        {
            get
            {
                ...
                {
                    _uriBuilderPath = string.Format("/subscriptions/{0}/resourceGroups/{1}/providers/Microsoft.Web/sites/{2}", subscriptionId, resourceGroupName, appName);
                }
