...
{
    public class AzureImageCreate : IActivity
    {
        ...
        {
            string originalApi = api_version;
            postData = GetBody();
            httpMethod = "PUT";
            api_version = originalApi;
        ...
        private string GetBody()
        {
            ...
            if (response.StatusCode == HttpStatusCode.OK)
            {
                ...
                JToken osDisk = (JToken)json["properties"]["storageProfile"]["osDisk"];
                            ...
                            properties : {
                             storageProfile: {
                                osDisk : { 
                                    ...
                                    caching: """ + osDisk["caching"].ToString() + @""",
                                    diskSizeGB: " + osDisk["diskSizeGB"].ToString() + @",
                                    managedDisk: { id: """ + osDisk["managedDisk"]["id"].ToString() + @""" }
                                },
                                dataDisks: [],
                                zoneResilient: false
                             }
