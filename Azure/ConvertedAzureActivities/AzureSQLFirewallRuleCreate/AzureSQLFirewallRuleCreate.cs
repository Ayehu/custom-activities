...
{
    public class AzureSQLFirewallRuleCreate : IActivity
    {
        ...
        private string uriBuilderPath
        {
            get
            {
                ...
                {
                    _uriBuilderPath = string.Format("/subscriptions/{0}/resourceGroups/{1}/providers/Microsoft.Sql/servers/{2}/firewallRules/{3}", subscriptionId, resourceGroupName, serverName, firewallRuleName);
                }
