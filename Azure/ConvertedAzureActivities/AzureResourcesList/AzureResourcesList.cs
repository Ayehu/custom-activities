...
{
    public class AzureResourcesList : IActivity
    {
        /// <summary>
                ...
                case HttpStatusCode.OK:
                    {
                        ...
                        foreach (var res in values)
                        {
                            if(res["name"] != null && res["type"] != null)
                                sb.Append(@"{ ""name"":" + @"""" + res["name"].ToString() + @"""," + @"""type"":" + @"""" + res["type"].ToString() + @"""},");
                        }

                        sb.Append("]");

                        if (string.IsNullOrEmpty(response.Content.ReadAsStringAsync().Result) == false)
                            return this.GenerateActivityResult(sb.ToString(), Jsonkeypath);
                        else
