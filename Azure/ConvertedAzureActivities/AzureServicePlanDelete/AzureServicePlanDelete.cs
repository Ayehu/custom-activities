...
{
    public class AzureServicePlanDelete : IActivity
    {
        ...
        private string uriBuilderPath
        {
            get
            {
                ...
                {
                    _uriBuilderPath = string.Format("/subscriptions/{0}/resourceGroups/{1}/providers/Microsoft.Web/serverfarms/{2}", subscriptionId, resourceGroupName, servicePlanName);
                }
