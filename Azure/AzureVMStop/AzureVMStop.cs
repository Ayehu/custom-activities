...
_uriBuilderPath = string.Format("/subscriptions/{0}/resourceGroups/{1}/providers/Microsoft.Compute/virtualMachines/{2}/powerOff",subscriptionId,resourceGroupName,vm_name);
            }
