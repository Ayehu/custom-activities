...
namespace Ayehu.Azure_Network
{
    public class AzureGetNetworkSecurityGroup : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/subscriptions/{0}/resourceGroups/{1}/providers/Microsoft.Network/networkSecurityGroups/{2}/",subscriptionId,resourceGroupName,networkSecurityGroupName);
            }
