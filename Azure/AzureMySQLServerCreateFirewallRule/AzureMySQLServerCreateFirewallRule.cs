...
{
    public class AzureMySQLServerCreateFirewallRule : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/subscriptions/{0}/resourceGroups/{1}/providers/Microsoft.DBForMySQL/servers/{2}/firewallRules/{3}",subscriptionId,resourceGroupName,db_name,rule_name);
            }
    ...
    private string postData {
        get {
            if (string.IsNullOrEmpty(_postData)) {
                _postData = "{ \"properties\": { \"startIpAddress\": \"" + start_ip + "\", \"endIpAddress\": \"" + end_ip + "\" } }";
            }
return _postData;
        }
        set {
