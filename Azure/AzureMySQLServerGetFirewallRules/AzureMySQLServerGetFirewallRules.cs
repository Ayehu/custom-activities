...
{
    public class AzureMySQLServerGetFirewallRules : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/subscriptions/{0}/resourceGroups/{1}/providers/Microsoft.DBForMySQL/servers/{2}/firewallRules",subscriptionId,resourceGroupName,db_name);
            }
