...
namespace Ayehu.Azure_Disk
{
    public class AzureUpdateDiskSize : IActivityAsync
    {
...
_uriBuilderPath = string.Format("/subscriptions/{0}/resourceGroups/{1}/providers/Microsoft.Compute/disks/{2}",subscriptionId,resourceGroupName,disk_name);
            }
    ...
    private string postData {
        get {
            if (string.IsNullOrEmpty(_postData)) {
                ...
                _postData = "{ \"location\": \"" + disk_location + "\", \"properties\": { \"diskSizeGB\": " + disk_size + " } }";
            }
return _postData;
        }
        set {
