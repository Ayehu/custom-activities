...
{
    public class AzureDeleteNetworkInterface : IActivity
    {
        /// <summary>
        ...
        public ICustomActivityResult Execute()
        {
            ...
            if (network != null)
            {
                azure.NetworkInterfaces.DeleteById(network.Id);
                return this.GenerateActivityResult(GetActivityResult);
            }
            else
                throw new Exception(string.Format("Network interface with name {0} not found", networkName));
