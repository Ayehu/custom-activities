...
{
    public class CustomActivity_TY_Get_a_Workflow_Template_Audit_List : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("SecretServer/api/v1/workflows/templates/{0}/audits",id_p);
        }
    }
