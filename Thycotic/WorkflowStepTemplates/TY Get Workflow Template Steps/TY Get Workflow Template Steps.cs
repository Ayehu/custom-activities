...
{
    public class TY_Get_Workflow_Template_Steps : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public TY_Get_Workflow_Template_Steps() {
    }
    
    public TY_Get_Workflow_Template_Steps(string endPoint, string Jsonkeypath, string password1, string id_p, string skip, string sortBy_0__direction, string sortBy_0__name, string sortBy_0__priority, string take) {
