...
{
    public class TY_ServiceGetRequestsForSecret : IActivityAsync
    {
...
_uriBuilderPath = string.Format("SecretServer/api/v1/secret-access-requests/secrets/{0}",id_p);
            }
...
return _queryStringArray;
    ...
    public TY_ServiceGetRequestsForSecret() {
    }
    
    public TY_ServiceGetRequestsForSecret(string endPoint, string Jsonkeypath, string password1, string id_p, string skip, string sortBy_0__direction, string sortBy_0__name, string sortBy_0__priority, string take) {
