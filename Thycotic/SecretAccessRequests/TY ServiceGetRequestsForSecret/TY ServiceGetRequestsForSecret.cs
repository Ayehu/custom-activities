...
{
    public class CustomActivity_TY_ServiceGetRequestsForSecret : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("SecretServer/api/v1/secret-access-requests/secrets/{0}",id_p);
        }
    }
