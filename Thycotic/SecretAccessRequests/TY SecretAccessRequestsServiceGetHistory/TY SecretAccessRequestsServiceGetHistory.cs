...
{
    public class CustomActivity_TY_SecretAccessRequestsServiceGetHistory : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("SecretServer/api/v1/secret-access-requests/{0}/history",id_p);
        }
    }
