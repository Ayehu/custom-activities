...
{
    public class TY_Delete_Secret_Hook : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public TY_Delete_Secret_Hook() {
    }
    
    public TY_Delete_Secret_Hook(string endPoint, string Jsonkeypath, string password1, string secretHookId, string secretId) {
