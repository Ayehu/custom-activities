...
{
    public class TY_Search_scripts : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public TY_Search_scripts() {
    }
    
    public TY_Search_scripts(string endPoint, string Jsonkeypath, string password1, string filter_includeInactive, string filter_searchText, string skip, string sortBy_0__direction, string sortBy_0__name, string sortBy_0__priority, string take) {
