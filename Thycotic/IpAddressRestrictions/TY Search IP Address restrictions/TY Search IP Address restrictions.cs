...
{
    public class TY_Search_IP_Address_restrictions : IActivityAsync
    {
...
_uriBuilderPath = "SecretServer/api/v1/ipaddress-restrictions";
            }
...
return _queryStringArray;
    ...
    public TY_Search_IP_Address_restrictions() {
    }
    
    public TY_Search_IP_Address_restrictions(string endPoint, string Jsonkeypath, string password1, string skip, string sortBy_0__direction, string sortBy_0__name, string sortBy_0__priority, string take) {
