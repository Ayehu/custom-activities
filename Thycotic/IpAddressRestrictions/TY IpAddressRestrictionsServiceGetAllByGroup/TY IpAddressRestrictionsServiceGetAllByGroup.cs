...
{
    public class CustomActivity_TY_IpAddressRestrictionsServiceGetAllByGroup : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("SecretServer/api/v1/groups/{0}/ipaddress-restrictions",id_p);
        }
    }
