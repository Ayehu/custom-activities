...
{
    public class CustomActivity_TY_IpAddressRestrictionsServiceGetAllByUser : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("SecretServer/api/v1/users/{0}/ipaddress-restrictions",id_p);
        }
    }
