...
{
    public class TY_IpAddressRestrictionsServiceSearchUsers : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public TY_IpAddressRestrictionsServiceSearchUsers() {
    }
    
    public TY_IpAddressRestrictionsServiceSearchUsers(string endPoint, string Jsonkeypath, string password1, string id_p, string skip, string sortBy_0__direction, string sortBy_0__name, string sortBy_0__priority, string take) {
