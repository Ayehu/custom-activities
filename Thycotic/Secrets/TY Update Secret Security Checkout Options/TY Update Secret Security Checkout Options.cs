...
namespace Ayehu.Thycotic
{
    ...
    public string Jsonkeypath = "security-checkout";
    ...
    public string checkOutEnabled_dirty = "";
    
    public string checkOutEnabled_value = "";
    
    public string checkOutIntervalMinutes_dirty = "";
    
    public string checkOutIntervalMinutes_value = "";
