...
{
    public class CustomActivity_TY_Get_Secret_Search_Total : IActivityAsync
    {
    ...
    public string Jsonkeypath = "search-total";
    ...
    private string uriBuilderPath {
        get {
            return "SecretServer/api/v1/secrets/search-total";
        }
    }
