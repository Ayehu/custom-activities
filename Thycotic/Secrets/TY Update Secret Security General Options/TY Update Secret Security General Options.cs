...
{
    public class CustomActivity_TY_Update_Secret_Security_General_Options : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("SecretServer/api/v1/secrets/{0}/security-general",id_p);
        }
    }
    
    private string postData {
        get {
            return string.Format("{{ \"data\": {{   \"doubleLockId\": {{     \"dirty\": \"{0}\",      \"value\": \"{1}\"     }},    \"enableDoubleLock\": {{     \"dirty\": \"{2}\",      \"value\": \"{3}\"     }},    \"hideLauncherPassword\": {{     \"dirty\": \"{4}\",      \"value\": \"{5}\"     }},    \"proxyEnabled\": {{     \"dirty\": \"{6}\",      \"value\": \"{7}\"     }},    \"requiresComment\": {{     \"dirty\": \"{8}\",      \"value\": \"{9}\"     }},    \"sessionRecordingEnabled\": {{     \"dirty\": \"{10}\",      \"value\": \"{11}\"     }}   }} }}",dirty,value,enableDoubleLock_dirty,enableDoubleLock_value,hideLauncherPassword_dirty,hideLauncherPassword_value,proxyEnabled_dirty,proxyEnabled_value,requiresComment_dirty,requiresComment_value,sessionRecordingEnabled_dirty,sessionRecordingEnabled_value);
        }
    }
