...
{
    public class TY_Get_Users_In_Group : IActivityAsync
    {
...
_uriBuilderPath = string.Format("SecretServer/api/v1/groups/{0}/users",id_p);
            }
...
return _queryStringArray;
    ...
    public TY_Get_Users_In_Group() {
    }
    
    public TY_Get_Users_In_Group(string endPoint, string Jsonkeypath, string password1, string id_p, string skip, string sortBy_0__direction, string sortBy_0__name, string sortBy_0__priority, string take) {
