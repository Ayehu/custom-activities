...
{
    public class CustomActivity_TY_ServiceGetSecretPoliciesForPipelinePolicies : IActivityAsync
    {
    ...
    private string uriBuilderPath {
        get {
            return string.Format("SecretServer/api/v1/event-pipeline-policy/{0}/secretpolicies",id_p);
        }
    }
