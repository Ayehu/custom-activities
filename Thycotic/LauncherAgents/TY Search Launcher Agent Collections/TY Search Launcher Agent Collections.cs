...
{
    public class TY_Search_Launcher_Agent_Collections : IActivityAsync
    {
...
return _queryStringArray;
    ...
    public TY_Search_Launcher_Agent_Collections() {
    }
    
    public TY_Search_Launcher_Agent_Collections(string endPoint, string Jsonkeypath, string password1, string filter_includeInactive, string filter_searchText, string skip, string sortBy_0__direction, string sortBy_0__name, string sortBy_0__priority, string take) {
