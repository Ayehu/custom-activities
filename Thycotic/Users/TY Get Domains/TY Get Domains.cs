...
{
    public class TY_Get_Domains : IActivityAsync
    {
...
_uriBuilderPath = "SecretServer/api/v1/domains";
            }
...
return _queryStringArray;
    ...
    public TY_Get_Domains() {
    }
    
    public TY_Get_Domains(string endPoint, string Jsonkeypath, string password1, string skip, string sortBy_0__direction, string sortBy_0__name, string sortBy_0__priority, string take) {
