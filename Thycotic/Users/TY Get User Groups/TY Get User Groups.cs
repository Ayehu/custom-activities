...
{
    public class TY_Get_User_Groups : IActivityAsync
    {
...
_uriBuilderPath = string.Format("SecretServer/api/v1/users/{0}/groups",id_p);
            }
...
return _queryStringArray;
    ...
    public TY_Get_User_Groups() {
    }
    
    public TY_Get_User_Groups(string endPoint, string Jsonkeypath, string password1, string id_p, string skip, string sortBy_0__direction, string sortBy_0__name, string sortBy_0__priority, string take) {
