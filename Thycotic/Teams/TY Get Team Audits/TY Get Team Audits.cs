...
{
    public class TY_Get_Team_Audits : IActivityAsync
    {
...
_uriBuilderPath = string.Format("SecretServer/api/v1/teams/{0}/audits",id_p);
            }
...
return _queryStringArray;
    ...
    public TY_Get_Team_Audits() {
    }
    
    public TY_Get_Team_Audits(string endPoint, string Jsonkeypath, string password1, string id_p, string skip, string sortBy_0__direction, string sortBy_0__name, string sortBy_0__priority, string take) {
