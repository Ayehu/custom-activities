...
{
    public class TY_Get_the_Proxy_Audit_List : IActivityAsync
    {
    ...
    public string Jsonkeypath = "audit";
...
_uriBuilderPath = "SecretServer/api/v1/proxy/audit";
            }
...
return _queryStringArray;
    ...
    public TY_Get_the_Proxy_Audit_List() {
    }
    
    public TY_Get_the_Proxy_Audit_List(string endPoint, string Jsonkeypath, string password1, string skip, string sortBy_0__direction, string sortBy_0__name, string sortBy_0__priority, string take) {
